(function() {
    ...
    (function() {
        var zebkitEnvironment = function() {
            var pkg = {},
                hostRe = /([a-zA-Z]+)\:\/\/([^/:]+)/,
                isFF = typeof navigator !== "undefined" && navigator.userAgent.toLowerCase().indexOf("firefox") >= 0;
            ...
            $Request.prototype.open = function(method, url, async, user, password) {
                ...
                if (window.location.scheme.toLowerCase() === "file:" || m !== null && m[2] !== undefined && m[2].toLowerCase() === window.location.host.toLowerCase()) {
            ...
            pkg.getHttpRequest = function() {
                ...
                return "withCredentials" in r ? r : new $Request
            };
            ...
            if (typeof window !== "undefined") {
                var $taskMethod = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(callback) {
                ...
                pkg.decodeURIComponent = function(s) {
                    return s
                };
                pkg.encodeURIComponent = function(s) {
                    return s
                }
            }
            ...
            function buildFontHelpers() {
                ...
                if (e === null) {
                    ...
                    e.innerHTML = "<span id='zebkit.fm.text' style='display:inline;vertical-align:baseline;'>&nbsp;</span>" + "<img id='zebkit.fm.image' style='width:1px;height:1px;display:inline;vertical-align:baseline;' width='1' height='1'/>";
    ...
    DoIt.prototype = {
            ...
            if (body instanceof DoIt) {
                ...
                if (this.$error === null) {
                    if (level === 0 && this.$busy === 0) {
                        if (this.$results[level] !== null && this.$results[level] !== undefined && this.$results[level].length > 0) {
        ...
        till: function(r) {
            this.then(function() {
                var $this = this,
                    jn = this.join(),
                    res = arguments.length > 0 ? Array.prototype.slice.call(arguments) : [];
                r.then(function() {
                    if ($this.$error === null) {
                        if (res.length > 0) {
                            jn.apply($this, res)
    ...
    var $exports = {},
        $zenv = {},
        $global = typeof window !== "undefined" && window !== null ? window : typeof global !== "undefined" ? global : this,
        $isInBrowser = typeof navigator !== "undefined",
        isIE = $isInBrowser && (Object.hasOwnProperty.call(window, "ActiveXObject") || !!window.ActiveXObject || window.navigator.userAgent.indexOf("Edge") > -1),
    ...
    if (parseInt.name !== "parseInt") {
        $FN = function(f) {
            if (f.$methodName === undefined) {
                var mt = f.toString().match(/^function\s+([^\s(]+)/);
                f.$methodName = mt === null ? "" : mt[1] === undefined ? "" : mt[1]
            }
            return f.$methodName
        }
    } else {
...
console.error(url);
    ...
    function dumpError(e) {
        if (typeof console !== "undefined" && typeof console.log !== "undefined") {
            ...
            if (typeof Date !== "undefined") {
                var date = new Date;
                msg = msg + date.getDate() + "/" + (date.getMonth() + 1) + "/" + date.getFullYear() + " " + date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds()
            }
            if (e === null || e === undefined) {
                console.log("Unknown error")
            } else {
    ...
    function image(ph, fireErr) {
        ...
        $zenv.loadImage(ph, function(img) {
            jn(img)
        }, function(img, e) {
            if (fireErr === true) {
                doit.error(e)
    ...
    function isString(o) {
        return o !== undefined && o !== null && (typeof o === "string" || o.constructor === String)
    }

    function isNumber(o) {
        return o !== undefined && o !== null && (typeof o === "number" || o.constructor === Number)
    }

    function isBoolean(o) {
        return o !== undefined && o !== null && (typeof o === "boolean" || o.constructor === Boolean)
    }

    function isAtomic(v) {
        return v === null || v === undefined || (typeof v === "string" || v.constructor === String) || (typeof v === "number" || v.constructor === Number) || (typeof v === "boolean" || v.constructor === Boolean)
    }
    ...
    function getPropertyValue(obj, path, useGetter) {
        ...
        for (var i = 0; i < paths.length; i++) {
            var p = paths[i],
                m = null;
            if (obj !== undefined && obj !== null && (useGetter === true && (m = getPropertyGetter(obj, p)) || obj.hasOwnProperty(p))) {
                ...
                if (k[0] === "-") {
                    ...
                    if (recursive === true) {
                        ...
                        if (pv !== null && (tv === null || tv === undefined || !(tv instanceof Object))) {
                            throw new Error("Target value is null, undefined or not an object. '" + k + "' property cannot be applied as recursive")
                        }
                    } else {
                        tv = target[k]
                    }
    ...
    URI.prototype = {
        ...
        qs: null,
        toString: function() {
            return (this.scheme !== null ? this.scheme + "://" : "") + (this.host !== null ? this.host : "") + (this.port !== -1 ? ":" + this.port : "") + (this.path !== null ? this.path : "") + (this.qs !== null ? "?" + this.qs : "")
        },
        getParent: function() {
            if (this.path === null) {
                return null
                ...
                return i < 0 || this.path === "/" ? null : new URI(this.scheme, this.host, this.port, this.path.substring(0, i), this.qs)
            }
        },
        ...
        relative: function(to) {
            ...
            if (this.isAbsolute() && to.isAbsolute() && this.host === to.host && this.port === to.port && (this.scheme === to.scheme || this.isFilePath() && to.isFilePath()) && (this.path.indexOf(to.path) === 0 && (to.path.length === this.path.length || to.path.length === 1 && to.path[0] === "/" || this.path[to.path.length] === "/"))) {
                return to.path.length === 1 && to.path[0] === "/" ? this.path.substring(to.path.length) : this.path.substring(to.path.length + 1)
            } else {
                return null
            }
        }
    ...
    URI.parseQS = function(qs, decode) {
        ...
        if (mqs !== null) {
            for (var i = 0; i < mqs.length; i++) {
                var q = mqs[i].split("="),
                    k = q[0].trim(),
                    v = decode === true ? $zenv.decodeURIComponent(q[1]) : q[1];
    ...
    URI.decodeQSValue = function(value) {
        if (Array.isArray(value)) {
            ...
            if (value[0] === "'") {
                ...
                var num = value.indexOf(".") >= 0 ? parseFloat(value) : parseInt(value, 10);
                if (isNaN(num) === false) {
                    value = num
                }
            }
    ...
    URI.toQS = function(obj, encode) {
        ...
        for (var k in obj) {
            if (obj.hasOwnProperty(k)) {
                p.push(k + "=" + (encode === true ? $zenv.encodeURIComponent(obj[k].toString()) : obj[k].toString()))
            }
        }
        return p.join("&")
    };
    ...
    $export(URI, isNumber, isString, $Map, isAtomic, dumpError, image, getPropertySetter, getPropertyValue, getPropertyGetter, properties, GET, isBoolean, DoIt, {
        $global: $global,
        $FN: $FN,
        ZFS: ZFS,
        environment: $zenv,
    ...
    function $cpMethods(src, dest, clazz) {
        ...
        for (var name in src) {
            if (name !== CNAME && name !== "clazz" && src.hasOwnProperty(name)) {
                var method = src[name];
    ...
    function $make_template(instanceOf, templateConstructor, inheritanceList) {
        ...
        if (arguments.length > 2 && inheritanceList.length > 0) {
            for (var i = 0; i < inheritanceList.length; i++) {
                ...
                if (toInherit === undefined || toInherit === null || typeof toInherit !== "function" || toInherit.$hash$ === undefined) {
    ...
    function clone(obj, map) {
        if (obj === null || obj === undefined || obj.$notCloneable === true || (typeof obj === "string" || obj.constructor === String) || (typeof obj === "boolean" || obj.constructor === Boolean) || (typeof obj === "number" || obj.constructor === Number)) {
            return obj
        }
        map = map || new Map;
        var t = map.get(obj);
    ...
    var Interface = $make_template(null, function() {
        var $Interface = $make_template(Interface, function() {
            if (typeof this === "undefined" || this.constructor !== $Interface) {
                if (arguments.length !== 1) {
                ...
                iclone.prototype.$prototype = $make_proto(arguments[0], $Interface.prototype.$prototype);
                return iclone
            } else {
                if (arguments.length > 1) {
                ...
                for (var name in this.prototype) {
                    if (name !== "clazz" && this.prototype.hasOwnProperty(name)) {
                        ...
                        if (typeof f === "function") {
                            A.prototype[name] = f.methodBody !== undefined ? $ProxyMethod(name, f.methodBody, f.boundTo) : f;
    ...
    var classTemplateProto = {
        ...
        $super: function() {
            if ($caller !== null) {
                ...
                throw new ReferenceError("Method '" + cln + ($caller.methodName === CNAME ? "constructor" : $caller.methodName) + "(" + arguments.length + ")" + "' not found")
            } else {
    ...
    var Class = $make_template(null, function() {
        ...
        var classTemplate = $make_template(Class, function() {
            ...
            if (arguments.length > 0) {
                ...
                if (Array.isArray(a) === true && typeof a[0] === "function") {
                    a = a[0];
                    var args = [classTemplate],
                        k = arguments.length - 2;
                    for (; k >= 0 && arguments[k].clazz === Interface; k--) {
                        args.push(arguments[k])
                    }
                    args.push(arguments[arguments.length - 1]);
                    var cl = Class.apply(null, args),
                        f = function() {};
                    cl.$name = classTemplate.$name;
        ...
        if (parentClass !== null) {
            for (var k in parentClass.prototype) {
                if (parentClass.prototype.hasOwnProperty(k)) {
                    ...
                    classTemplate.prototype[k] = f !== undefined && f !== null && f.hasOwnProperty("methodBody") ? $ProxyMethod(f.methodName, f.methodBody, f.boundTo) : f
                }
            }
        }
        ...
        if (toInherit.length > 0) {
            for (var idx = toInherit[0].clazz === Interface ? 0 : 1; idx < toInherit.length; idx++) {
                ...
                for (var sk in ic) {
                    if (sk[0] !== "$" && ic.hasOwnProperty(sk) === true && classTemplate.hasOwnProperty(sk) === false) {
        ...
        if (parentClass !== null) {
            for (var key in parentClass) {
                if (key[0] !== "$" && parentClass.hasOwnProperty(key) && classTemplate.hasOwnProperty(key) === false) {
    ...
    function instanceOf(obj, clazz) {
        if (clazz !== null && clazz !== undefined) {
            if (obj === null || obj === undefined) {
                ...
                return obj.clazz !== undefined && obj.clazz !== null && (obj.clazz === clazz || obj.clazz.$parents[clazz.$hash$] !== undefined)
            }
        }
    ...
    var Zson = Class([function(root) {
        ...
        this.then = function(json, root, cb) {
            ...
            var zson = arguments.length > 1 && root !== null ? new Zson(root) : new Zson;
        ...
        this.callMethod = function(name, d) {
            ...
            var args = this.buildValue(Array.isArray(d) ? d : [d]),
                $this = this;
            if (this.$runner.$tasks.length === ts && this.$runner.$busy === bs) {
        ...
        this.buildValue = function(d) {
            if (d === undefined || d === null || d instanceof DoIt || (typeof d === "number" || d.constructor === Number) || (typeof d === "boolean" || d.constructor === Boolean)) {
                return d
            }
            if (Array.isArray(d)) {
        ...
        this.merge = function(dest, src, recursively) {
            ...
            for (var k in src) {
                if (src.hasOwnProperty(k)) {
                    ...
                    if (isAtomic(dv) || Array.isArray(dv) || isAtomic(sv) || Array.isArray(sv) || sv.clazz !== undefined) {
        ...
        this.resolveClass = function(className) {
            return this.classAliases.hasOwnProperty(className) ? this.classAliases[className] : Class.forName(className)
        };
    ...
    function findInTree(root, path, cb, eq, m) {
        ...
        if (eq === null || arguments.length < 4) {
            eq = function(n, fragment) {
                return n.value === fragment
            }
        }
        if (root.kids !== undefined && root.kids !== null && root.kids.length > 0) {
    ...
    var PathSearch = Interface([function $prototype() {
        this.byPath = function(path, cb) {
            ...
            if (arguments.length === 2) {
                if (arguments[1] === null) {
                    ...
                    findInTree(this, path, cb, this.$matchPath !== undefined ? this.$matchPath : null)
                }
            } else {
                var res = null;
                findInTree(this, path, function(n) {
    ...
    var Event = Class([function $prototype() {
        this.source = null
    }]);
    var $NewListener = function() {
        var clazz = function() {};
        clazz.eventNames = arguments.length === 0 ? ["fired"] : Array.prototype.slice.call(arguments);
        clazz.ListenersClass = function() {
            var args = this.eventNames.slice();
            for (var i = 0; i < arguments.length; i++) {
        ...
        if (clazz.eventNames.length === 1) {
            ...
            clazz.prototype.remove = function(l) {
                if (this.v !== null) {
                    if (arguments.length === 0) {
                        ...
                        var name = arguments.length > 1 || zebkit.isString(arguments[0]) ? arguments[0] : null,
                            fn = arguments.length > 1 ? arguments[1] : name === null ? arguments[0] : null,
                            i = 0;
            ...
            clazz.prototype.hasHandler = function(l) {
                if (zebkit.isString(l)) {
                    return this.$methods !== null && this.$methods.hasOwnProperty(l) && this.$methods[l].length > 0
                } else {
    ...
    var EventProducer = Interface([function $prototype() {
        this.on = function() {
        ...
        this.fire = function(name) {
            if (arguments.length > 0 && arguments.length < 3) {
                if (this._ !== undefined) {
                    ...
                    if (arguments.length === 2) {
                        Array.isArray(arguments[1]) ? this._[name].apply(this._, arguments[1]) : this._[name].call(this._, arguments[1])
                    } else {
    ...
    var Font = Class([function(family, style, size) {
        if (arguments.length === 1) {
        ...
        if (this.s === null) {
            this.s = (this.style !== null ? this.style + " " : "") + this.size + " " + this.family
        }
        ...
        this.charsWidth = function(s, off, len) {
            ...
            return Math.round(fm.measureText(len === 1 ? s[off] : s.substring(off, off + len)).width)
        };
    ...
    Package.prototype.$detectLocation = function() {
        if (typeof __dirname !== "undefined") {
            ...
            a.href = i > 0 ? ss.substring(0, i + 1) : document.location.toString();
    ...
    var $textualFileExtensions = ["txt", "json", "htm", "html", "md", "properties", "conf", "xml", "java", "js", "css", "scss", "log"],
        $imageFileExtensions = ["jpg", "jpeg", "png", "tiff", "gif", "ico", "exif", "bmp"];
    ...
    Package.prototype.configWith = function(path, cb) {
        ...
        if (arguments.length > 1 && cb !== null) {
            ...
            this.getRootPackage().then(function() {
                this.till(new Zson($this).then(path))
            })
        }
    };
    Package.prototype.configWithRs = function(path, cb) {
        ...
        return arguments.length > 1 ? this.configWith(path, cb) : this.configWith(path)
    };
    $export(Package);
...
zebkit.package("util", function(pkg, Class) {
    ...
    pkg.compareDates = function(d1, d2) {
        ...
        var day1, month1, year1, day2, month2, year2, i = 1;
    ...
    pkg.validateDate = function(day, month, year) {
        var d = arguments.length < 3 ? arguments.length === 1 ? day : new Date(month, day) : new Date(year, month, day);
        if (d.isValid() === false) {
    ...
    pkg.isIntersect = function(x1, y1, w1, h1, x2, y2, w2, h2) {
        return Math.min(x1 + w1, x2 + w2) - (x1 > x2 ? x1 : x2) > 0 && Math.min(y1 + h1, y2 + h2) - (y1 > y2 ? y1 : y2) > 0
    };
    ...
    pkg.Position = Class([function(pi) {
        this.isValid = false;
        this.currentLine = this.currentCol = this.offset = 0;
        this.setMetric(pi)
    }, function $clazz() {
        this.Metric = zebkit.Interface(["abstract", function getLines() {}, function getLineSize() {}, function getMaxOffset() {}])
    }, function $prototype() {
        ...
        this.removed = function(off, size) {
            if (this.offset >= 0 && this.offset >= off) {
                this.isValid = false;
                this.setOffset(this.offset >= off + size ? this.offset - size : off)
            }
        };
    ...
    pkg.SingleColPosition = Class(pkg.Position, [function $prototype() {
        this.setRowCol = function(r, c) {
            this.setOffset(r)
        };
        this.setOffset = function(o) {
...
zebkit.package("data", function(pkg, Class) {
    ...
    pkg.TextModel = Class(pkg.DataModel, [function $prototype() {
    ...
    pkg.TextEvent = Class(zebkit.Event, [function $prototype() {
        this.id = null;
        this.line = 0;
        this.lines = 0;
        this.offset = 0;
    ...
    pkg.Text = Class(pkg.TextModel, [function(s) {
        ...
        this.removeLines = function(start, size) {
            ...
            var end = start + size - 1,
                off = this.calcLineOffset(start),
                olen = start !== end ? this.calcLineOffset(end) + this.$lines[end].$s.length + 1 - off : this.$lines[start].$s.length + 1;
        ...
        this.insertLines = function(startLine) {
            ...
            var off = this.calcLineOffset(startLine),
                offlen = 0;
        ...
        this.setValue = function(text) {
            ...
            if (old !== text) {
                if (old.length > 0) {
                    var numLines = this.getLines(),
                        txtLen = this.getTextLength();
                    this.$lines.length = 0;
                    this.$lines = [new this.clazz.Line("")];
    ...
    pkg.SingleLineTxt = Class(pkg.TextModel, [function(s, max) {
        if (arguments.length > 1) {
            this.maxLen = max
        }
        this.setValue(arguments.length === 0 || s === null ? "" : s)
        ...
        this.write = function(s, offset, b) {
            ...
            var l = this.maxLen > 0 && this.$buf.length + s.length >= this.maxLen ? this.maxLen - this.$buf.length : s.length;
            if (l !== 0) {
                var nl = offset === this.$buf.length ? this.$buf + s.substring(0, l) : this.$buf.substring(0, offset) + s.substring(0, l) + this.$buf.substring(offset);
                this.$buf = nl;
                if (l > 0) {
        ...
        this.remove = function(offset, size, b) {
            if (size > 0 && offset < this.$buf.length) {
                ...
                if (size > 0) {
                    var nl = this.$buf.substring(0, offset) + this.$buf.substring(offset + size);
    ...
    pkg.ListModel = Class(pkg.DataModel, zebkit.EventProducer, [function() {
    ...
    pkg.TreeModel = Class(pkg.DataModel, [function(r) {
        if (arguments.length === 0) {
    ...
    pkg.Matrix = Class(pkg.DataModel, [function() {
        if (arguments.length === 1) {
        ...
        this.puti = function(i, obj) {
            this.put(Math.floor(i / this.cols), i % this.cols, obj);
            return this
        };
        ...
        this.sortCol = function(col, f) {
            ...
            this.fire("matrixSorted", [this, {
                col: col,
                func: f,
                name: zebkit.$FN(f).toLowerCase()
            }])
        }
    }]).events("matrixResized", "cellModified", "matrixSorted", "matrixRowInserted", "matrixColInserted")
});
zebkit.package("io", function(pkg, Class) {
    ...
    pkg.b64encode = function(input) {
        ...
        while (i < len) {
            c1 = input.charCodeAt(i++) & 255;
            out.push(b64str.charAt(c1 >> 2));
            if (i === len) {
                out.push(b64str.charAt((c1 & 3) << 4), "==");
                break
            }
            c2 = input.charCodeAt(i++);
            out.push(b64str.charAt((c1 & 3) << 4 | (c2 & 240) >> 4));
            if (i === len) {
                out.push(b64str.charAt((c2 & 15) << 2), "=");
                break
            }
            c3 = input.charCodeAt(i++);
            out.push(b64str.charAt((c2 & 15) << 2 | (c3 & 192) >> 6), b64str.charAt(c3 & 63))
        }
        return out.join("")
    };
    ...
    pkg.ISO8601toDate = function(v) {
        var regexp = ["([0-9]{4})(-([0-9]{2})(-([0-9]{2})", "(T([0-9]{2}):([0-9]{2})(:([0-9]{2})(.([0-9]+))?)?", "(Z|(([-+])([0-9]{2}):([0-9]{2})))?)?)?)?"].join(""),
            d = v.match(new RegExp(regexp)),
            offset = 0,
        ...
        date.setTime(Number(date) + offset * 60 * 1e3);
        return date
    };
    pkg.HTTP = Class([function(url) {
        this.url = url;
        this.header = {}
    }, function $prototype() {
        this.GET = function(q) {
            var u = this.url + (arguments.length === 0 || q === null ? "" : (this.url.indexOf("?") > 0 ? "&" : "?") + zebkit.URI.toQS(q, true));
    ...
    pkg.Service = Class([function(url, methods) {
        var $this = this;
        this.url = url;
        if (Array.isArray(methods) === false) {
            methods = [methods]
    ...
    pkg.JRPC = Class(pkg.Service, [function $prototype() {
        this.version = "2.0";
    ...
    pkg.Base64.prototype.toString = function() {
        return this.encoded
    };
    pkg.Base64.prototype.decode = function() {
        return pkg.b64decode(this.encoded)
    };
    pkg.XRPC = Class(pkg.Service, [function $prototype() {
            ...
            if (tag === "struct") {
                ...
                for (i = 0; i < node.childNodes.length; i++) {
                    var member = node.childNodes[i],
                        key = member.childNodes[0].childNodes[0].nodeValue.trim();
                    p[key] = this.decodeValue(member.childNodes[1].childNodes[0])
                }
                return p
            }
            if (tag === "array") {
                ...
                for (i = 0; i < node.childNodes.length; i++) {
                    a[i] = this.decodeValue(node.childNodes[i].childNodes[0])
                }
                return a
            }
        ...
        this.decode = function(r) {
            ...
            c = c.childNodes[0].childNodes[0];
            if (c.tagName.toLowerCase() === "param") {
                return this.decodeValue(c.childNodes[0].childNodes[0])
            }
...
zebkit.package("layout", function(pkg, Class) {
    ...
    pkg.Layout = new zebkit.Interface(["abstract", function doLayout(target) {}, function calcPreferredSize(target) {}]);
    ...
    pkg.Layoutable = Class(pkg.Layout, zebkit.EventProducer, zebkit.PathSearch, [function() {
        this.kids = [];
        this.layout = this
    }, function $prototype() {
        ...
        this.$matchPath = function(node, name) {
            if (name[0] === "~") {
                return node.clazz !== undefined && node.clazz !== null && zebkit.instanceOf(node, zebkit.Class.forName(name.substring(1)))
            } else {
                return node.clazz.$name !== undefined && node.clazz.$name === name
            }
        };
        ...
        this.validate = function() {
            ...
            if (this.width > 0 && this.height > 0 && this.isLayoutValid === false && this.isVisible === true) {
        ...
        this.add = function(constr, d) {
            return arguments.length === 1 ? this.insert(this.kids.length, null, constr) : this.insert(this.kids.length, constr, d)
        }
    }]);
    pkg.StackLayout = Class(pkg.Layout, [function $prototype() {
        this.calcPreferredSize = function(target) {
        ...
        this.doLayout = function(t) {
            ...
            for (var i = 0; i < t.kids.length; i++) {
                ...
                if (l.isVisible === true) {
                    ...
                    if (ctr === "usePsSize") {
                        var ps = l.getPreferredSize();
                        l.setBounds(left + Math.floor((ww - ps.width) / 2), top + Math.floor((hh - ps.height) / 2), ps.width, ps.height)
                    } else {
    ...
    pkg.BorderLayout = Class(pkg.Layout, [function(hgap, vgap) {
        if (arguments.length > 0) {
                ...
                if (l.isVisible === true) {
                    switch (l.constraints) {
                        ...
                        case "right":
                            ...
                            break;
                        default:
                            throw new Error("Invalid constraints: " + l.constraints)
                    }
                }
            }
            var dim = {
                ...
                if (kid.isVisible === true) {
                    switch (kid.constraints) {
                        ...
                        case "right":
                            ...
                            break;
                        default:
                            throw new Error("Invalid constraints: '" + kid.constraints + "'")
                    }
                }
            }
            if (right !== null) {
    ...
    pkg.RasterLayout = Class(pkg.Layout, [function(usePsSize) {
        if (arguments.length > 0) {
    ...
    pkg.FlowLayout = Class(pkg.Layout, [function(ax, ay, dir, g) {
        if (arguments.length === 1) {
            this.gap = ax
        } else {
            if (arguments.length > 1) {
        ...
        this.doLayout = function(c) {
            var psSize = this.calcPreferredSize(c),
                ...
                px = (this.ax === "right" ? ew - psSize.width : this.ax === "center" ? Math.floor((ew - psSize.width) / 2) : 0) + l,
                py = (this.ay === "bottom" ? eh - psSize.height : this.ay === "center" ? Math.floor((eh - psSize.height) / 2) : 0) + t;
            for (var i = 0; i < c.kids.length; i++) {
                var a = c.kids[i];
                if (a.isVisible === true) {
                    var d = a.getPreferredSize(),
                    ...
                    if (this.direction === "horizontal") {
                        ...
                        a.setLocation(px, ctr === "stretch" ? t : ctr === "top" ? py : ctr === "bottom" ? Math.floor(psSize.height - d.height) + py : Math.floor((psSize.height - d.height) / 2) + py);
                        px += d.width + this.gap
                    } else {
                        ctr = ctr || this.ax;
                        if (ctr === "stretch") {
                        ...
                        a.setLocation(ctr === "stretch" ? l : ctr === "left" ? px : ctr === "right" ? px + Math.floor(psSize.width - d.width) : px + Math.floor((psSize.width - d.width) / 2), py);
    ...
    pkg.ListLayout = Class(pkg.Layout, [function(ax, gap) {
        if (arguments.length === 1) {
            this.gap = ax
        } else if (arguments.length > 1) {
            ...
            for (var i = 0; i < lw.kids.length; i++) {
                ...
                if (cc.isVisible === true) {
                    var d = cc.getPreferredSize(),
                        constr = cc.constraints === null ? this.ax : cc.constraints;
                    cc.setSize(constr === "stretch" ? psw : d.width, d.height);
                    cc.setLocation(constr === "stretch" ? x : x + (constr === "right" ? psw - cc.width : constr === "center" ? Math.floor((psw - cc.width) / 2) : 0), y);
                    y += d.height + this.gap
                }
            }
        }
    }]);
    pkg.PercentLayout = Class(pkg.Layout, [function(dir, gap, stretch) {
        if (arguments.length > 0) {
            this.direction = zebkit.util.validateValue(dir, "horizontal", "vertical");
            if (arguments.length > 1) {
                this.gap = gap
        ...
        this.doLayout = function(target) {
            ...
            for (var i = 0; i < size; i++) {
                var l = target.kids[i],
                    ...
                    useps = c === "usePsSize";
                if (this.direction === "horizontal") {
                    ns = size - 1 === i ? target.width - right - loc : useps ? l.getPreferredSize().width : Math.floor(rs * c / 100);
                    var yy = top,
                        hh = target.height - top - bottom;
                    ...
                    ns = size - 1 === i ? target.height - bottom - loc : useps ? l.getPreferredSize().height : Math.floor(rs * c / 100);
                    var xx = left,
                        ww = target.width - left - right;
                    if (this.stretch === false) {
                        var pw = ww;
    ...
    pkg.Constraints = Class([function(ax, ay, p) {
        if (arguments.length > 0) {
            this.ax = ax;
            if (arguments.length > 1) {
                this.ay = ay
    ...
    pkg.GridLayout = Class(pkg.Layout, [function(r, c, stretchRows, stretchCols) {
        this.rows = r;
        this.cols = c;
            ...
            for (i = 0; i < rows && cc < c.kids.length; i++) {
                ...
                for (var j = 0; j < cols && cc < c.kids.length; j++, cc++) {
                    ...
                    if (l.isVisible === true) {
                        ...
                        l.setLocation(xx + arg.left + ("stretch" === arg.ax ? 0 : arg.ax === "right" ? cellW - d.width : arg.ax === "center" ? Math.floor((cellW - d.width) / 2) : 0), top + arg.top + ("stretch" === arg.ay ? 0 : arg.ay === "bottom" ? cellH - d.height : arg.ay === "center" ? Math.floor((cellH - d.height) / 2) : 0));
                        xx += colSizes[j]
                    }
                }
                top += rowSizes[i]
...
zebkit.package("draw", function(pkg, Class) {
    ...
    pkg.$view = function(v) {
        if (v === null || v.paint !== undefined) {
            ...
            if (pkg.rgb[v] !== undefined) {
                return pkg.rgb[v]
            } else if (pkg.$views[v] !== undefined) {
                return pkg.$views[v]
            } else {
                if (v.length > 0 && (v[0] === "#" || v.length > 2 && v[0] === "r" && v[1] === "g" && v[2] === "b")) {
    ...
    pkg.View = Class([function $prototype() {
        this.gap = 2;
    ...
    pkg.Render = Class(pkg.View, [function(target) {
        if (arguments.length > 0) {
    ...
    pkg.rgb = Class(pkg.View, [function(r, g, b, a) {
        this.isOpaque = true;
        if (arguments.length === 1) {
                ...
                if (r[0] === "#") {
                    if (r.length >= 7) {
                        ...
                        if (r.length > 4) {
                            ...
                            this.isOpaque = this.a === 15
                        }
                    }
                } else if (r[0] === "r" && r[1] === "g" && r[2] === "b") {
                    var i = r.indexOf("(", 3),
        ...
        if (this.s === null) {
            this.s = this.isOpaque === false ? "rgba(" + this.r + "," + this.g + "," + this.b + "," + this.a + ")" : "#" + (this.r < 16 ? "0" + this.r.toString(16) : this.r.toString(16)) + (this.g < 16 ? "0" + this.g.toString(16) : this.g.toString(16)) + (this.b < 16 ? "0" + this.b.toString(16) : this.b.toString(16))
        }
    }, function $prototype() {
        this.s = null;
        this.gap = 0;
        ...
        this.silver = new this(192, 192, 192);
        this.grey = this.gray = new this(128, 128, 128);
        this.white = new this(16777215);
        this.maroon = new this(8388608);
        this.red = new this(255, 0, 0);
        this.purple = new this(8388736);
        this.fuchsia = new this(16711935);
        this.green = new this(32768);
        this.lime = new this(65280);
        this.olive = new this(8421376);
        this.yellow = new this(255, 255, 0);
        this.navy = new this(128);
        this.blue = new this(0, 0, 255);
        this.teal = new this(32896);
        this.aqua = new this(65535);
        this.orange = new this(255, 165, 0);
        this.aliceblue = new this(15792383);
        this.antiqueWhite = this.antiquewhite = new this(16444375);
        this.aquamarine = new this(8388564);
        this.azure = new this(15794175);
        this.beige = new this(16119260);
        this.bisque = new this(16770244);
        this.blanchedalmond = new this(16772045);
        this.blueViolet = this.blueviolet = new this(9055202);
        this.brown = new this(10824234);
        this.burlywood = new this(14596231);
        this.cadetblue = new this(6266528);
        this.chartreuse = new this(8388352);
        this.chocolate = new this(13789470);
        this.coral = new this(16744272);
        this.cornflowerblue = new this(6591981);
        this.cornsilk = new this(16775388);
        this.crimson = new this(14423100);
        this.cyan = new this(0, 255, 255);
        this.darkBlue = this.darkblue = new this(139);
        this.darkCyan = this.darkcyan = new this(35723);
        this.darkGoldenrod = this.darkgoldenrod = new this(12092939);
        this.darkGrey = this.darkgrey = this.darkGray = this.darkgray = new this(11119017);
        this.darkGreen = this.darkgreen = new this(25600);
        this.darkKhaki = this.darkkhaki = new this(12433259);
        this.darkMagenta = this.darkmagenta = new this(9109643);
        this.darkOliveGreen = this.darkolivegreen = new this(5597999);
        this.darkOrange = this.darkorange = new this(16747520);
        this.darkOrchid = this.darkorchid = new this(10040012);
        this.darkRed = this.darkred = new this(9109504);
        this.darkSalmon = this.darksalmon = new this(15308410);
        this.darkSeaGreen = this.darkseagreen = new this(9419919);
        this.darkSlateBlue = this.darkslateblue = new this(4734347);
        this.darkSlateGrey = this.darkSlateGray = this.darkslategray = this.darkslategrey = new this(3100495);
        this.darkTurquoise = this.darkturquoise = new this(52945);
        this.darkViolet = this.darkviolet = new this(9699539);
        this.deepPink = this.deeppink = new this(16716947);
        this.dimGrey = this.dimGray = this.dimgray = this.dimgrey = new this(6908265);
        this.dodgerBlue = this.dodgerblue = new this(2003199);
        this.firebrick = new this(11674146);
        this.floralwhite = new this(16775920);
        this.forestgreen = new this(2263842);
        this.gainsboro = new this(14474460);
        this.ghostwhite = new this(16316671);
        this.gold = new this(16766720);
        this.goldenrod = new this(14329120);
        this.greenyellow = new this(11403055);
        this.honeydew = new this(15794160);
        this.hotpink = new this(16738740);
        this.indianred = new this(13458524);
        this.indigo = new this(4915330);
        this.ivory = new this(16777200);
        this.khaki = new this(15787660);
        this.lavender = new this(15132410);
        this.lavenderblush = new this(16773365);
        this.lawngreen = new this(8190976);
        this.lemonchiffon = new this(16775885);
        this.lightBlue = this.lightblue = new this(11393254);
        this.lightCoral = this.lightcoral = new this(15761536);
        this.lightCyan = this.lightcyan = new this(14745599);
        this.lightGoldenRodYellow = this.lightgoldenrodyellow = new this(16448210);
        this.lightGrey = this.lightGray = this.lightgray = this.lightgrey = new this(13882323);
        this.lightGreen = this.lightgreen = new this(9498256);
        this.lightPink = this.lightpink = new this(16758465);
        this.lightSalmon = this.lightsalmon = new this(16752762);
        this.lightSeaGreen = this.lightseagreen = new this(2142890);
        this.lightSkyBlue = this.lightskyblue = new this(8900346);
        this.lightSlateGrey = this.lightSlateGray = this.lightslategrey = this.lightslategray = new this(7833753);
        this.lightSteelBlue = this.lightsteelblue = new this(11584734);
        this.lightYellow = this.lightyellow = new this(16777184);
        this.linen = new this(16445670);
        this.magenta = new this(16711935);
        this.pink = new this(16761035);
        this.transparent = new this(0, 0, 0, 0);
        this.mergeable = false
    }]);
    pkg.CompositeView = Class(pkg.View, [function() {
        this.views = [];
    ...
    pkg.ViewSet = Class(pkg.CompositeView, [function(views) {
        ...
        this.activate = function(id) {
            ...
            return this.views.hasOwnProperty("*") ? (this.activeView = this.views["*"]) !== old : false
        };
        this.iterate = function(f) {
    ...
    pkg.Shape = Class(pkg.View, [function(c, fc, w) {
        if (arguments.length > 0) {
            this.color = c;
            if (arguments.length > 1) {
                this.fillColor = fc;
    ...
    pkg.Sunken = Class(pkg.View, [function(brightest, middle, darkest) {
        if (arguments.length > 0) {
    ...
    pkg.Etched = Class(pkg.View, [function(brightest, middle) {
        if (arguments.length > 0) {
            this.brightest = brightest;
            if (arguments.length > 1) {
                this.middle = middle
    ...
    pkg.Raised = Class(pkg.View, [function(brightest, middle) {
        if (arguments.length > 0) {
            this.brightest = brightest;
            if (arguments.length > 1) {
                this.middle = middle
    ...
    pkg.Dotted = Class(pkg.View, [function(c) {
        if (arguments.length > 0) {
            this.color = c
        }
    }, function $prototype() {
    ...
    pkg.Border = Class(pkg.View, [function(c, w, r) {
        if (arguments.length > 0) {
            this.color = c;
            if (arguments.length > 1) {
    ...
    pkg.RoundBorder = Class(pkg.View, [function(col, width) {
        if (arguments.length > 0) {
        ...
        this.outline = function(g, x, y, w, h, d) {
            ...
            if (w === h) {
                g.beginPath();
                g.arc(Math.floor(x + w / 2) + (w % 2 === 0 ? 0 : .5), Math.floor(y + h / 2) + (h % 2 === 0 ? 0 : .5), Math.floor((w - g.lineWidth) / 2), 0, 2 * Math.PI, false);
                g.closePath()
            } else {
                g.ovalPath(x, y, w, h)
            }
    ...
    pkg.TitledBorder = Class(pkg.Render, [function(b, a) {
        if (arguments.length > 1) {
        ...
        this.outline = function(g, x, y, w, h, d) {
                    ...
                    switch (r.orient) {
                        case "bottom":
                            ...
                            switch (this.lineAlignment) {
                                case "center":
                                    yy = r.y + Math.floor((r.height - bottom) / 2) + bottom;
                                    break;
                                case "top":
                                    yy = r.y + r.height + bottom;
                                    break;
                                case "bottom":
                                    yy = r.y;
                                    break
                        ...
                        case "top":
                            ...
                            switch (this.lineAlignment) {
                                case "center":
                                    y = r.y + Math.floor((r.height - top) / 2);
                                    break;
                                case "top":
                                    y = r.y - top;
                                    break;
                        ...
                        case "left":
                            ...
                            switch (this.lineAlignment) {
                                case "center":
                                    x = r.x + Math.floor((r.width - left) / 2);
                                    break;
                                case "top":
                                    x = r.x - left;
                                    break;
                        ...
                        case "right":
                            ...
                            switch (this.lineAlignment) {
                                case "center":
                                    xx = r.x + Math.floor((r.width - right) / 2) + right;
                                    break;
                                case "top":
                                    xx = r.x + r.width + right;
                                    break;
                                case "bottom":
                                    xx = r.x;
                                    break
            ...
            if (this.target !== null && this.target.outline !== undefined && this.target.outline(g, x, y, xx - x, yy - y, d) === true) {
                return true
            }
            g.beginPath();
                ...
                if (r !== null) {
                    ...
                    switch (r.orient) {
                        case "top":
                            ...
                            if (this.$isIn(t, x + this.target.getLeft(), y, w - this.target.getRight() - this.target.getLeft(), yy - y - this.target.getBottom())) {
                                return
                            }
                            g.save();
                            g.beginPath();
                        ...
                        case "bottom":
                            ...
                            if (this.$isIn(t, x + this.target.getLeft(), y + this.target.getTop(), w - this.target.getRight() - this.target.getLeft(), yy - y - this.target.getTop())) {
                                return
                            }
                            g.save();
                            g.beginPath();
                        ...
                        case "left":
                            ...
                            if (this.$isIn(t, x, y + this.target.getTop(), xx - x - this.target.getRight(), h - this.target.getTop() - this.target.getBottom())) {
                                return
                            }
                            g.save();
                            g.beginPath();
                        ...
                        case "right":
                            ...
                            if (this.$isIn(t, x + this.target.getLeft(), y + this.target.getTop(), xx - x - this.target.getLeft(), h - this.target.getTop() - this.target.getBottom())) {
                                return
                            }
                            g.save();
                            g.beginPath();
                            ...
                            break;
                        default:
                            throw new Error("Invalid title orientation " + r.orient)
                    }
                    g.closePath();
                    g.clip();
    ...
    pkg.BaseTextRender = Class(pkg.Render, [function $clazz() {
        this.font = pkg.font;
        this.color = "gray";
    ...
    pkg.StringRender = Class(pkg.BaseTextRender, zebkit.util.Position.Metric, [function $prototype() {
        this.stringWidth = -1;
        ...
        this.remove = function(off, len) {
            this.target = this.target.substring(0, off) + this.target.substring(off + len);
            return true
        };
        this.replace = function(s, off, size) {
            if (s.length === 0) {
        ...
        this.paint = function(g, x, y, w, h, d) {
            ...
            if (d !== null && d.getStartSelection !== undefined) {
                ...
                if (startSel !== null && endSel !== null && startSel.col !== endSel.col && d.selectView !== null) {
                    d.selectView.paint(g, x + this.font.charsWidth(this.target, 0, startSel.col), y, this.font.charsWidth(this.target, startSel.col, endSel.col - startSel.col), this.getLineHeight(), d)
                }
            }
            ...
            if (d !== null && d.isEnabled === false) {
                g.fillStyle = d !== null && d.disabledColor !== null && d.disabledColor !== undefined ? d.disabledColor : this.clazz.disabledColor
            }
    ...
    pkg.TextRender = Class(pkg.BaseTextRender, zebkit.util.Position.Metric, [function $prototype() {
            ...
            if (ts.width > 0 && ts.height > 0) {
                ...
                if (startInvLine < size) {
                    ...
                    if (d === null || d.isEnabled === true) {
                        ...
                        var dcol = d !== null && d.disabledColor !== null && d.disabledColor !== undefined ? d.disabledColor : pkg.TextRender.disabledColor;
                        for (i = 0; i < lines; i++) {
                            g.setColor(dcol);
                            this.paintLine(g, x, y, i + startInvLine, d);
                            y += lilh
    ...
    pkg.CutStringRender = Class(pkg.StringRender, [function $prototype() {
        this.maxWidth = -1;
        this.dots = "..."
    ...
    pkg.WrappedTextRender = Class(pkg.TextRender, [function $prototype() {
        this.$brokenLines = [];
        this.$lastWidth = -1;
        ...
        return this.$lastWidth < 0 ? this.$super() : this.$brokenLines.length
    }, function getLine(i) {
        return this.$lastWidth < 0 ? this.$super(i) : this.$brokenLines[i]
        ...
        if (arguments.length > 0) {
            ...
            return {
                width: pw,
                height: bl.length * this.getLineHeight() + (bl.length - 1) * this.lineIndent
            }
        } else {
            return this.$super()
        }
    ...
    pkg.DecoratedTextRender = zebkit.Class(pkg.TextRender, [function(text) {
        this.decorations = {
            underline: false,
            strike: false,
            overline: false
    ...
    pkg.BoldTextRender = Class(pkg.TextRender, [function $clazz() {
        this.font = pkg.boldFont
    }]);
    pkg.PasswordText = Class(pkg.TextRender, [function(text) {
        if (arguments.length === 0) {
    ...
    pkg.TriangleShape = Class(pkg.Shape, [function $prototype() {
        this.outline = function(g, x, y, w, h, d) {
            g.beginPath();
            w -= 2 * this.lineWidth;
            h -= 2 * this.lineWidth;
    ...
    pkg.Gradient = Class(pkg.View, [function() {
    ...
    pkg.Radial = Class(pkg.View, [function() {
        this.colors = [];
        for (var i = 0; i < arguments.length; i++) {
        ...
        this.paint = function(g, x, y, w, h, d) {
            var cx1 = Math.floor(w / 2),
                cy1 = Math.floor(h / 2),
                rad2 = w > h ? w : h;
            if (this.$gradient === null || this.$cx1 !== cx1 || this.$cy1 !== cy1 || this.$rad1 !== this.radius || this.$rad2 !== this.rad2) {
    ...
    pkg.Picture = Class(pkg.Render, [function(img, x, y, w, h) {
        this.setValue(img);
        if (arguments.length === 2) {
        ...
        this.paint = function(g, x, y, w, h, d) {
            if (this.target !== null && this.target.complete === true && this.target.naturalWidth > 0 && w > 0 && h > 0) {
                if (this.x >= 0) {
                    g.drawImage(this.target, this.x, this.y, this.width, this.height, x, y, w, h)
                } else {
        ...
        this.getPreferredSize = function() {
            var img = this.target;
            return img === null || img.naturalWidth <= 0 || img.complete !== true ? {
                width: 0,
                height: 0
            } : this.width > 0 ? {
                width: this.width,
    ...
    pkg.Pattern = Class(pkg.Render, [function $prototype() {
        this.$pattern = null;
        this.paint = function(g, x, y, w, h, d) {
    ...
    pkg.LineView = Class(pkg.View, [function(side, color, lineWidth) {
        if (arguments.length > 0) {
        ...
        this.paint = function(g, x, y, w, h, t) {
            ...
            } else if (this.side === "verCenter") {} else if (this.side === "horCenter") {}
            g.stroke()
        };
        this.getPreferredSize = function() {
            return {
    ...
    pkg.ArrowView = Class(pkg.Shape, [function(direction, color, fillColor) {
        if (arguments.length > 0) {
    ...
    pkg.TabBorder = Class(pkg.View, [function(t, w) {
        if (arguments.length > 1) {
            this.width = w
        }
        if (arguments.length > 0) {
        ...
        this.paint = function(g, x, y, w, h, d) {
            ...
            switch (o) {
                ...
                case "bottom":
                    ...
                    break;
                default:
                    throw new Error("Invalid tab alignment")
            }
        };
        this.getTop = function() {
            return this.top
    ...
    pkg.CheckboxView = Class(pkg.View, [function(color) {
        if (arguments.length > 0) {
            this.color = color
        }
    }, function $prototype() {
    ...
    pkg.ThumbView = Class(pkg.Shape, [function(dir, color, fillColor, lineWidth) {
        if (arguments.length > 0) {
        ...
        this.outline = function(g, x, y, w, h, d) {
            ...
            if (this.direction === "vertical") {
                ...
                r = h / 2;
                g.arc(x + r, y + r, r, .5 * Math.PI, 1.5 * Math.PI, false);
                g.lineTo(x + w - r, y);
                g.arc(x + w - r, y + h - r, r, 1.5 * Math.PI, .5 * Math.PI, false);
                g.lineTo(x + r, y + h)
            }
        }
    }]);
    pkg.RadioView = Class(pkg.View, [function(outerColor, innerColor) {
        if (arguments.length > 0) {
        ...
        this.paint = function(g, x, y, w, h, d) {
            ...
            g.arc(Math.floor(x + w / 2), Math.floor(y + h / 2), Math.floor(w / 3 - .5), 0, 2 * Math.PI, 1, false);
            g.fill();
            g.beginPath();
            if (g.fillStyle !== this.innerColor) {
                g.fillStyle = this.innerColor
            }
            g.arc(Math.floor(x + w / 2), Math.floor(y + h / 2), Math.floor(w / 4 - .5), 0, 2 * Math.PI, 1, false);
            g.fill()
        }
    }]);
    pkg.ToggleView = Class(pkg.View, [function(plus, color, bg, w, h, br) {
        if (arguments.length > 0) {
            this.plus = plus;
            if (arguments.length > 1) {
                this.color = color;
    ...
    pkg.CaptionBgView = Class(pkg.View, [function(bg, gap, radius) {
        if (arguments.length > 0) {
            this.bg = bg;
            if (arguments.length > 1) {
                this.gap = gap;
    ...
    pkg.CloudView = Class(pkg.Shape, [function outline(g, x, y, w, h, d) {
        g.beginPath();
        g.moveTo(x + w * .2, y + h * .25);
        g.bezierCurveTo(x, y + h * .25, x, y + h * .75, x + w * .2, y + h * .75);
        g.bezierCurveTo(x + .1 * w, y + h - 1, x + .8 * w, y + h - 1, x + w * .7, y + h * .75);
        g.bezierCurveTo(x + w - 1, y + h * .75, x + w - 1, y, x + w * .65, y + h * .25);
        g.bezierCurveTo(x + w - 1, y, x + w * .1, y, x + w * .2, y + h * .25);
        g.closePath();
        return true
    }]);
    pkg.FunctionRender = Class(pkg.Render, [function(fn, x1, x2, granularity) {
        this.$super(fn);
        this.setRange(x1, x2);
        if (arguments.length > 3) {
        ...
        this.paint = function(g, x, y, w, h, c) {
            if (this.target !== null) {
                ...
                g.setColor(this.color);
                g.lineWidth = this.lineWidth;
                g.moveTo(this.lineWidth, sy + dy - (this.$fy[0] - this.$miny) * cy);
                for (var i = 1; i < this.$fy.length; i++) {
                    g.lineTo(this.lineWidth + vx * cx, sy + dy - (this.$fy[i] - this.$miny) * cy);
                    vx += this.$dx
                }
                g.stroke()
            }
    ...
    pkg.PentahedronShape = Class(pkg.Shape, [function outline(g, x, y, w, h, d) {
        g.beginPath();
        x += this.lineWidth;
        y += this.lineWidth;
        w -= 2 * this.lineWidth;
    ...
    pkg.BaseViewProvider = Class([function(render) {
        this.render = arguments.length === 0 || render === undefined ? new zebkit.draw.StringRender("") : render;
...
zebkit.package("ui.event", function(pkg, Class) {
    ...
    pkg.PointerEvent = Class(zebkit.Event, [function $prototype() {
        ...
        this.update = function(source, ax, ay) {
            if (this.source === source && this.source.parent === source.parent && source.x === this.$px && source.y === this.$py) {
                this.x += ax - this.absX;
                this.y += ay - this.absY;
                this.absX = ax;
                this.absY = ay;
    ...
    pkg.EventManager = Class(pkg.Manager, zebkit.EventProducer, [function() {
        this._ = new this.clazz.Listerners;
        this.$super()
    }, function $clazz() {
        var eventNames = ["keyTyped", "keyReleased", "keyPressed", "pointerDragged", "pointerDragStarted", "pointerDragEnded", "pointerMoved", "pointerClicked", "pointerDoubleClicked", "pointerPressed", "pointerReleased", "pointerEntered", "pointerExited", "focusLost", "focusGained", "compSized", "compMoved", "compEnabled", "compShown", "compAdded", "compRemoved"];
        ...
        this.fire = function(id, e) {
            ...
            e.id = id;
            if (e.source.suppressEvent !== undefined && e.source.suppressEvent(e) === true) {
                return true
            }
    ...
    pkg.Clipboard = Class(pkg.Manager, [function $prototype() {
        this.getDestination = function() {
            return zebkit.ui.focusManager.focusOwner
        }
    }]);
    pkg.CursorManager = Class(pkg.Manager, [function $prototype() {
    ...
    pkg.InputEventState = zebkit.Interface([function $prototype() {
        this.state = OUT;
        this.$isIn = false;
        this._keyPressed = function(e) {
            if (this.state !== PRESSED_OVER && this.state !== PRESSED_OUT && (e.code === "Enter" || e.code === "Space")) {
    ...
    pkg.FocusEvent = Class(zebkit.Event, [function $prototype() {
        this.related = null
    }]);
    var FOCUS_EVENT = new pkg.FocusEvent;
    pkg.FocusManager = Class(pkg.Manager, [function $prototype() {
        this.focusOwner = null;
        this.$freeFocus = function(comp) {
            if (this.focusOwner !== null && (this.focusOwner === comp || zebkit.layout.isAncestorOf(comp, this.focusOwner))) {
        ...
        this.isFocusable = function(c) {
            var d = c.getCanvas();
            if (d !== null && (c.canHaveFocus === true || typeof c.canHaveFocus === "function" && c.canHaveFocus() === true)) {
        ...
        this.fd = function(t, index, d) {
            if (t.kids.length > 0) {
                ...
                for (var i = index; i >= 0 && i < t.kids.length; i += d) {
                    var cc = t.kids[i];
                    if (cc.isEnabled === true && cc.isVisible === true && cc.width > 0 && cc.height > 0 && (isNComposite || t.catchInput !== true && t.catchInput(cc) === false) && (cc.canHaveFocus === true || cc.canHaveFocus !== undefined && cc.canHaveFocus !== false && cc.canHaveFocus() || (cc = this.fd(cc, d > 0 ? 0 : cc.kids.length - 1, d)) !== null)) {
                        return cc
                    }
                }
            }
    ...
    pkg.ShortcutEvent = Class(zebkit.Event, [function(src, shortcut, keys) {
        this.source = src;
        this.shortcut = shortcut;
        this.keys = keys
    }]);
    var SHORTCUT_EVENT = new pkg.ShortcutEvent;
    pkg.ShortcutManager = Class(pkg.Manager, [function(shortcuts) {
        this.$super();
        this.keyShortcuts = {};
        if (arguments.length > 0) {
...
zebkit.package("ui", function(pkg, Class) {
    ...
    this.config({
        basedir: basedir ? basedir : zebkit.URI.join(this.$url, "rs/themes/%{theme}"),
                ...
                if (canvas.$da.width > 0) {
                    ...
                    if (canvas.bg === null || canvas.bg.isOpaque !== true) {
                        if (canvas.$context.$scaleRatioIsInt === false) {
                            ...
                            canvas.$context.clipRect(canvas.$da.x - 1, canvas.$da.y - 1, canvas.$da.width + 2, canvas.$da.height + 2)
                        } else {
                            canvas.$context.clearRect(canvas.$da.x, canvas.$da.y, canvas.$da.width, canvas.$da.height);
                            canvas.$context.clipRect(canvas.$da.x, canvas.$da.y, canvas.$da.width, canvas.$da.height)
                        }
                    }
                    canvas.$da.width = -1;
    ...
    pkg.Panel = Class(zebkit.layout.Layoutable, [function $prototype() {
        this.repaint = function(x, y, w, h) {
            if (this.isVisible === true && (this.parent !== null || this.$context !== undefined)) {
                ...
                if (canvas.$waitingForPaint !== true && (canvas.isValid === false || canvas.$da.width > 0 || canvas.isLayoutValid === false)) {
        ...
        this.getEventDestination = function() {
            ...
            while ((p = p.parent) !== null) {
                if (p.catchInput !== undefined && (p.catchInput === true || p.catchInput !== false && p.catchInput(c) === true)) {
                    c = p
                }
            }
            return c
        ...
        this.paintComponent = function(g) {
            var ts = g.$states[g.$curState];
            if (ts.width > 0 && ts.height > 0 && this.isVisible === true) {
                if (this.isLayoutValid === false) {
                    this.validate()
                }
                var b = this.bg !== null && (this.parent === null || this.bg !== this.parent.bg);
                if (this.border !== null && this.border.outline !== undefined && (b === true || this.update !== undefined) && this.border.outline(g, 0, 0, this.width, this.height, this) === true) {
                    g.save();
                    g.clip();
                    if (b) {
                ...
                if (this.paint !== undefined) {
                    ...
                    if (left > 0 || right > 0 || top > 0 || bottom > 0) {
                        if (ts.width > 0 && ts.height > 0) {
                            ...
                            g.save();
                            g.clipRect(x1, y1, (cxcw < cright ? cxcw : cright) - x1, (cych < cbottom ? cych : cbottom) - y1);
                            this.paint(g);
                            g.restore()
                        }
                    } else {
        ...
        this.setBorderLayout = function() {
            this.setLayout(arguments.length > 0 ? new zebkit.layout.BorderLayout(arguments[0]) : new zebkit.layout.BorderLayout);
            return this
        };
        ...
        this.setStackLayout = function() {
            this.setLayout(arguments.length > 0 ? new zebkit.layout.StackLayout(arguments[0]) : new zebkit.layout.StackLayout);
            return this
        };
        ...
        this.getComponentAt = function(x, y) {
            ...
            if (this.kids.length > 0) {
                for (var i = this.kids.length; --i >= 0;) {
                    var kid = this.kids[i];
                    kid = kid.getComponentAt(x - kid.x, y - kid.y);
                    if (kid !== null) {
                        return kid
                    }
                }
        ...
        this.relocated = function(px, py) {
            ...
            if (p !== null && w > 0 && h > 0) {
                ...
                var w1 = p.width - nx,
                    ...
                    h1 = p.height - ny,
                    h2 = h + (y > py ? y - py : py - y);
                p.repaint(nx, ny, w1 < w2 ? w1 : w2, h1 < h2 ? h1 : h2)
            }
        };
        this.resized = function(pw, ph) {
            ...
            if (this.parent !== null) {
                this.parent.repaint(this.x, this.y, this.width > pw ? this.width : pw, this.height > ph ? this.height : ph)
            }
        };
        ...
        this.setBorder = function(v) {
            ...
            if (v != old) {
                ...
                if (old === null || v === null || old.getTop() !== v.getTop() || old.getLeft() !== v.getLeft() || old.getBottom() !== v.getBottom() || old.getRight() !== v.getRight()) {
                    this.invalidate()
                }
        ...
        this.removeAll = function() {
            if (this.kids.length > 0) {
                var size = this.kids.length,
                    mx1 = Number.MAX_VALUE,
                    my1 = mx1,
                    mx2 = 0,
                    my2 = 0;
                for (; size > 0; size--) {
    ...
    pkg.RootLayerMix = zebkit.Interface([function $clazz() {
        this.id = "root"
    }, function $prototype() {
    ...
    pkg.CompRender = Class(zebkit.draw.Render, [function $prototype() {
        this.getPreferredSize = function() {
            return this.target === null || this.target.isVisible === false ? {
                width: 0,
                height: 0
    ...
    pkg.$component = function(desc, instance) {
        ...
        if (zebkit.isString(desc)) {
            ...
            if (m !== null) {
                ...
                var ch = hasInstance && instance.clazz.Checkbox !== undefined ? new instance.clazz.Checkbox(txt) : new pkg.Checkbox(txt);
                ...
                if (m !== null) {
                    ...
                    var img = hasInstance && instance.clazz.ImagePan !== undefined ? new instance.clazz.ImagePan(path) : new pkg.ImagePan(path);
                    if (m[2] !== undefined) {
                    ...
                    if (txt.length === 0) {
                        ...
                        return hasInstance && instance.clazz.ImageLabel !== undefined ? new instance.clazz.ImageLabel(txt, img) : new pkg.ImageLabel(txt, img)
                    }
                } else {
                    return hasInstance && instance.clazz.Label !== undefined ? new instance.clazz.Label(desc) : new pkg.Label(desc)
                }
            }
            ...
            if (desc.length > 0 && Array.isArray(desc[0])) {
                ...
                var clz = hasInstance && instance.clazz.Combo !== undefined ? instance.clazz.Combo : pkg.Combo,
            ...
            return hasInstance && instance.clazz.ImagePan !== undefined ? new instance.clazz.ImagePan(desc) : new pkg.ImagePan(desc)
        } else if (zebkit.instanceOf(desc, zebkit.draw.View)) {
            var v = hasInstance && instance.clazz.ViewPan !== undefined ? new instance.clazz.ViewPan : new pkg.ViewPan;
            v.setView(desc);
            return v
        }
        return desc
    };
    pkg.DecorationViews = zebkit.Interface([function $prototype() {
    ...
    pkg.ViewPan = Class(pkg.Panel, [function $prototype() {
        this.view = null;
        this.paint = function(g) {
            if (this.view !== null) {
                var l = this.getLeft(),
                    t = this.getTop();
                this.view.paint(g, l, t, this.width - l - this.getRight(), this.height - t - this.getBottom(), this)
            }
        };
        ...
        this.calcPreferredSize = function(t) {
            return this.view !== null ? this.view.getPreferredSize() : {
                width: 0,
                height: 0
            }
        }
    }]);
    pkg.ImagePan = Class(pkg.ViewPan, [function(img, w, h) {
    ...
    pkg.Line = Class(pkg.Panel, [function() {
        this.$super();
        if (arguments.length > 0) {
        ...
        this.setColors = function() {
            this.colors = arguments.length === 1 ? Array.isArray(arguments[0]) ? arguments[0].slice(0) : [arguments[0]] : Array.prototype.slice.call(arguments);
            this.repaint();
            return this
        };
        this.paint = function(g) {
    ...
    pkg.Label = Class(pkg.ViewPan, [function(r) {
        if (arguments.length === 0) {
            this.setView(new zebkit.draw.StringRender(""))
        } else {
            if (typeof r === "string" || r.constructor === String) {
                this.setView(r.length === 0 || r.indexOf("\n") >= 0 ? new zebkit.draw.TextRender(new zebkit.data.Text(r)) : new zebkit.draw.StringRender(r))
            } else if (r.clazz !== undefined && r.getTextLength !== undefined && r.getLines !== undefined) {
        ...
        this.setModel = function(m) {
            this.setView(zebkit.isString(m) ? new zebkit.draw.StringRender(m) : new zebkit.draw.TextRender(m));
            return this
        };
    ...
    pkg.ImageLabel = Class(pkg.Panel, [function(txt, path, w, h) {
        var img = null,
            lab = null;
        if (arguments.length > 0) {
    ...
    pkg.Progress = Class(pkg.Panel, [function(orient) {
        this.$super();
        if (arguments.length > 0) {
        ...
        this.paint = function(g) {
            var left = this.getLeft(),
                ...
                top = this.getTop(),
                bottom = this.getBottom(),
                rs = this.orient === "horizontal" ? this.width - left - right : this.height - top - bottom,
                barSize = this.orient === "horizontal" ? this.barWidth : this.barHeight;
            if (rs >= barSize) {
                var vLoc = Math.floor(rs * this.value / this.maxValue),
                    x = left,
                    y = this.height - bottom,
                    bar = this.barView,
                    wh = this.orient === "horizontal" ? this.height - top - bottom : this.width - left - right;
                ...
                if (this.titleView !== null) {
                    ...
                    this.titleView.paint(g, Math.floor((this.width - ps.width) / 2), Math.floor((this.height - ps.height) / 2), ps.width, ps.height, this)
                }
            }
        };
        this.calcPreferredSize = function(l) {
            var barSize = this.orient === "horizontal" ? this.barWidth : this.barHeight,
                v1 = this.maxValue * barSize + (this.maxValue - 1) * this.gap,
                ps = this.barView.getPreferredSize();
            ps = this.orient === "horizontal" ? {
                width: v1,
                height: this.barHeight >= 0 ? this.barHeight : ps.height
            } : {
                width: this.barWidth >= 0 ? this.barWidth : ps.width,
                height: v1
            };
            if (this.titleView !== null) {
    ...
    pkg.StatePan = Class(pkg.ViewPan, [function $prototype() {
        this.state = null;
        this.setState = function(s) {
            if (s !== this.state) {
                var prev = this.state;
    ...
    pkg.FocusableComposite = zebkit.Interface([function $prototype() {
        ...
        this.paintOnTop = function(g) {
            ...
            if (this.focusMarkerView !== null && fc !== null && this.hasFocus()) {
                this.focusMarkerView.paint(g, fc.x - this.focusMarkerGaps, fc.y - this.focusMarkerGaps, this.focusMarkerGaps * 2 + fc.width, this.focusMarkerGaps * 2 + fc.height, this)
            }
        };
    ...
    pkg.ButtonRepeatMix = zebkit.Interface([function $prototype() {
    ...
    pkg.Button = Class(pkg.EvStatePan, pkg.FocusableComposite, pkg.ButtonRepeatMix, [function(t) {
        this.$super();
        ...
        this.Label = Class(pkg.Label, []);
        this.ViewPan = Class(pkg.ViewPan, [function(v) {
            this.$super();
            this.setView(v)
        }, function $prototype() {
    ...
    pkg.Group = Class([function(un) {
        ...
        this.$allowValueUpdate = function(src) {
            ...
            return this.selected !== src || src.getValue() === false || this.allowNoneSelected === true
        };
    ...
    pkg.Checkbox = Class(pkg.EvStatePan, pkg.FocusableComposite, [function(c) {
        ...
        this.toViewId = function(state) {
            if (this.isEnabled === true) {
                return this.getValue() ? state === "over" ? "pressed.over" : "pressed.out" : state === "over" ? "over" : "out"
            } else {
        ...
        if (this.$group !== null && this.getValue()) {
            ...
            if (d !== 0) {
                ...
                for (var i = p.indexOf(this) + d; i < p.kids.length && i >= 0; i += d) {
                    var l = p.kids[i];
                    if (l.isVisible === true && l.isEnabled === true && l.$group === this.$group) {
                        l.requestFocus();
                        l.setValue(true);
                        break
                    }
    ...
    pkg.Radiobox = Class(pkg.Checkbox, [function(lab, group) {
        if (arguments.length > 0) {
    ...
    pkg.Link = Class(pkg.Button, [function(s) {
        ...
        this.setFont = function(f) {
            var old = this.view !== null ? this.view.font : null;
            this.view.setFont.apply(this.view, arguments);
            if (old !== this.view.font) {
                this.vrp()
            }
        ...
        var k = this.toViewId(n),
            b = false;
        if (this.view !== null && this.view.color !== this.colors[k] && this.colors[k] !== null && this.colors[k] !== undefined) {
    ...
    pkg.Toolbar = Class(pkg.Panel, [function $clazz() {
        this.ToolPan = Class(pkg.EvStatePan, [function(c) {
    ...
    pkg.ArrowButton = Class(pkg.Button, [function(direction) {
        ...
        this.$super(o, n);
        if (this.statesToProps !== undefined && this.statesToProps !== null && this.statesToProps[n] !== undefined && this.statesToProps[n] !== null) {
            zebkit.properties(this, this.statesToProps[n], true)
        }
    }]);
    pkg.BorderPan = Class(pkg.Panel, [function(title, center, o, a) {
        if (arguments.length > 0) {
        ...
        this.doLayout = function(target) {
            ...
            if (this.label !== null && this.label.isVisible === true) {
                ...
                h = ps.height;
                this.label.setBounds(this.alignment === "left" ? left + this.indent : this.alignment === "right" ? this.width - right - ps.width - this.indent : Math.floor((this.width - ps.width) / 2), this.orient === "bottom" ? this.height - bottom - ps.height : top, ps.width, h)
            }
            if (this.content !== null && this.content.isVisible === true) {
                this.content.setBounds(left + this.hGap, (this.orient === "bottom" ? top : top + h) + this.vGap, this.width - right - left - 2 * this.hGap, this.height - top - bottom - h - 2 * this.vGap)
            }
        };
    ...
    pkg.SplitPan = Class(pkg.Panel, [function(f, s, o) {
        if (arguments.length > 2) {
            this.orient = o
        }
        this.$super();
        ...
        this.Bar = Class(pkg.EvStatePan, [function(target) {
            this.target = target;
            this.$super()
        }, function $prototype() {
            this.prevLoc = 0;
            ...
            this.pointerDragEnded = function(e) {
                var xy = this.target.normalizeBarLoc(this.target.orient === "vertical" ? this.x + e.x : this.y + e.y);
                if (xy > 0) {
                    this.target.setGripperLoc(xy)
                }
            };
            this.getCursorType = function(t, x, y) {
                return this.target.orient === "vertical" ? pkg.Cursor.W_RESIZE : pkg.Cursor.N_RESIZE
            }
        }])
    }, function $prototype() {
            ...
            if (this.orient === "horizontal") {
                ...
                if (this.gripper !== null) {
                    if (this.isMoveable === true) {
                        ...
                        this.gripper.setBounds(this.barLocation, Math.floor((h - bSize.height) / 2), bSize.width, bSize.height)
                    }
                }
                if (this.leftComp !== null) {
    ...
    pkg.CollapsiblePan = Class(pkg.Panel, [function(lab, content) {
        this.$super();
        ...
        this.Toogle = Class(pkg.Checkbox, [function $prototype() {
            this.cursorType = pkg.Cursor.HAND
        }, function $clazz() {
            this.layout = new zebkit.layout.FlowLayout
        }]);
        this.GroupPan = Class(pkg.Panel, [function() {
    ...
    pkg.StatusBarPan = Class(pkg.Panel, [function(gap) {
        if (arguments.length === 0) {
            gap = 2
        }
    ...
    pkg.StackPan = Class(pkg.Panel, [function() {
        this.$super(new zebkit.layout.StackLayout);
        for (var i = 0; i < arguments.length; i++) {
            this.add(arguments[i])
        }
    }]);
    pkg.ScrollManager = Class([function(c) {
        this.target = c
    }, function $prototype() {
        this.sx = this.sy = 0;
        this.getSX = function() {
    ...
    pkg.Scroll = Class(pkg.Panel, zebkit.util.Position.Metric, [function(t) {
        if (arguments.length > 0) {
        ...
        this.ArrowButton = Class(pkg.ArrowButton, [function $prototype() {
        ...
        this.isInThumb = function(x, y) {
            var bn = this.thumb;
            return bn !== null && bn.isVisible === true && bn.x <= x && bn.y <= y && bn.x + bn.width > x && bn.y + bn.height > y
        };
        this.amount = function() {
            var db = this.decBt;
            return this.orient === "vertical" ? this.incBt.y - db.y - db.height : this.incBt.x - db.x - db.width
        };
        this.pixel2value = function(p) {
            var db = this.decBt;
            return this.orient === "vertical" ? Math.floor(this.max * (p - db.y - db.height) / (this.amount() - this.thumb.height)) : Math.floor(this.max * (p - db.x - db.width) / (this.amount() - this.thumb.width))
        };
        this.value2pixel = function() {
            var db = this.decBt,
                bn = this.thumb,
                off = this.position.offset;
            return this.orient === "vertical" ? db.y + db.height + Math.floor((this.amount() - bn.height) * off / this.max) : db.x + db.width + Math.floor((this.amount() - bn.width) * off / this.max)
        };
        this.catchInput = function(child) {
            return child === this.thumb || this.thumb.kids.length > 0 && zebkit.layout.isAncestorOf(this.thumb, child)
        };
        ...
        this.pointerDragged = function(e) {
            if (Number.MAX_VALUE !== this.startDragLoc) {
                this.position.setOffset(this.pixel2value(this.thumbLoc - this.startDragLoc + (this.orient === "horizontal" ? e.x : e.y)))
            }
        };
        this.pointerDragStarted = function(e) {
        ...
        this.doLayout = function(target) {
            ...
            this.decBt.setBounds(left, top, b ? ps1.width : ew, b ? eh : ps1.height);
            this.incBt.setBounds(b ? this.width - right - ps2.width : left, b ? top : this.height - bottom - ps2.height, b ? ps2.width : ew, b ? eh : ps2.height);
            if (this.thumb !== null && this.thumb.isVisible === true) {
                var am = this.amount();
                if (am > minbs) {
                    var bsize = Math.max(Math.min(Math.floor(this.extra * am / this.max), am - minbs), minbs);
                    this.thumb.setBounds(b ? this.value2pixel() : left, b ? top : this.value2pixel(), b ? bsize : ew, b ? eh : bsize)
                } else {
    ...
    pkg.ScrollPan = Class(pkg.Panel, [function(c, scrolls, autoHide) {
        if (arguments.length < 2) {
            scrolls = "both"
        }
        ...
        this.ContentPanLayout = Class(zebkit.layout.Layout, [function $prototype() {
            this.calcPreferredSize = function(t) {
        ...
        var SM = this.ContentPanScrollManager = Class(pkg.ScrollManager, [function $prototype() {
            this.getSX = function() {
        ...
        this.ContentPan = Class(pkg.Panel, [function(c) {
        ...
        this.doLayout = function(target) {
            var sman = this.scrollObj === null ? null : this.scrollObj.scrollManager,
                ...
                bottom = this.getBottom(),
                left = this.getLeft(),
                ww = this.width - left - right,
                maxH = ww,
                hh = this.height - top - bottom,
                maxV = hh,
                so = this.scrollObj.getPreferredSize(),
                vps = this.vBar === null ? {
                    width: 0,
                    height: 0
                } : this.vBar.getPreferredSize(),
                hps = this.hBar === null ? {
                    width: 0,
                    height: 0
                } : this.hBar.getPreferredSize();
            if (this.hBar !== null && this.autoHide === false && (so.width > ww || so.height > hh && so.width > ww - vps.width)) {
                maxV -= hps.height
            }
            maxV = so.height > maxV ? so.height - maxV : -1;
            if (this.vBar !== null && this.autoHide === false && (so.height > hh || so.width > ww && so.height > hh - hps.height)) {
                maxH -= vps.width
            }
            ...
            if (this.scrollObj.isVisible === true) {
                this.scrollObj.setBounds(left, top, ww - (this.autoHide === false && this.vBar !== null && this.vBar.isVisible === true ? vps.width : 0), hh - (this.autoHide === false && this.hBar !== null && this.hBar.isVisible === true ? hps.height : 0))
            }
            if (this.$interval === 0 && this.autoHide === true) {
                hps.height = vps.width = 0
            }
            if (this.hBar !== null && this.hBar.isVisible === true) {
                this.hBar.setBounds(left, this.height - bottom - hps.height, ww - (this.vBar !== null && this.vBar.isVisible === true ? vps.width : 0), hps.height);
                this.hBar.setMaximum(maxH)
            }
            if (this.vBar !== null && this.vBar.isVisible === true) {
                this.vBar.setBounds(this.width - right - vps.width, top, vps.width, hh - (this.hBar !== null && this.hBar.isVisible === true ? hps.height : 0));
        ...
        this.posChanged = function(target, prevOffset, prevLine, prevCol) {
            if (this.$isPosChangedLocked === false) {
                if (this.autoHide === true) {
                    if (this.$interval === 0 && (this.vBar !== null && this.vBar.isVisible === true || this.hBar !== null && this.hBar.isVisible === true)) {
                        var $this = this;
                        if (this.vBar !== null) {
                            this.vBar.toFront()
                        }
    ...
    pkg.MobileScrollMan = Class(zebkit.ui.event.Manager, [function $prototype() {
        ...
        this.pointerDragged = function(e) {
            if (e.touchCounter === 1 && this.$target !== null && this.$identifier === e.identifier && e.direction !== null) {
        ...
        this.pointerDragEnded = function(e) {
            if (this.$target !== null && this.$timer === null && this.$identifier === e.identifier && (e.direction === "bottom" || e.direction === "top") && this.$target.vBar !== null && this.$target.vBar.isVisible && e.dy !== 0) {
                this.$dt = 2 * e.dy;
                this.$counter = 0;
                var $this = this;
    ...
    pkg.RulerPan = Class(pkg.Panel, [function(o) {
        this.$super();
        ...
        this.LabelsHighlighter = zebkit.Interface([function paintLabel(g, x, y, w, h, v, value) {
            ...
            if (this.highlighterView !== null && this.$selectedLabel !== null) {
                this.highlighterView.paint(g, this.$selectedLabel.x, this.$selectedLabel.y, this.$selectedLabel.w, this.$selectedLabel.h, this)
            }
            this.$super(g)
        }, function $prototype() {
            this.catchInput = true;
        ...
        this.NumLabels = Class(zebkit.draw.BaseViewProvider, [function(numPrecision) {
        ...
        this.PercentageLabels = Class(this.NumLabels, [function(numPrecision) {
            if (arguments.length === 0) {
                numPrecision = 0
            }
        ...
        this.showPercentage = function(precision) {
            this.setLabelsRender(new this.clazz.PercentageLabels(arguments.length > 0 ? precision : 0));
            return this
        };
        ...
        this.setLabelsFont = function() {
            if (this.provider !== null) {
                this.provider.setFont.apply(this.provider, arguments);
                this.vrp()
            }
            return this
        };
        this.setLabelsColor = function() {
            if (this.provider !== null) {
                this.provider.setColor.apply(this.provider, arguments);
                this.vrp()
            }
            return this
        };
        ...
        this.$getRulerSize = function() {
            var s = this.orient === "horizontal" ? this.width - this.getLeft() - this.getRight() : this.height - this.getTop() - this.getBottom();
        ...
        this.toLocation = function(v) {
            ...
            return this.orient === "vertical" ? this.height - this.getBottom() - this.$minGap - xy : this.getLeft() + this.$minGap + xy
        };
        this.toValue = function(xy) {
            var min = this.getMin(),
                max = this.getMax(),
                sl = this.orient === "horizontal" ? this.getLeft() + this.$minGap : this.getTop() + this.$minGap,
        ...
        this.recalcMetrics = function() {
            if (this.provider !== null && this.showLabels === true) {
                var minView = this.provider.getView(this, this.getMin()),
                    minViewPs = minView === null ? {
                        width: 0,
                        height: 0
                    } : minView.getPreferredSize(),
                    maxView = this.provider.getView(this, this.getMax()),
                    maxViewPs = maxView === null ? {
                        width: 0,
                        height: 0
                    } : maxView.getPreferredSize();
                if (this.orient === "horizontal") {
            ...
            if (this.orient === "vertical") {
                ...
                this.$psW = (this.showStrokes ? this.strokeSize : 0) + (this.$maxLabSize === 0 ? 0 : this.$maxLabSize + this.gap)
            } else {
                this.$psW = 50 * this.lineWidth + this.$minGap + this.$maxGap;
                this.$psH = (this.showStrokes ? this.strokeSize : 0) + (this.$maxLabSize === 0 ? 0 : this.$maxLabSize + this.gap)
            }
        };
        this.paint = function(g) {
            if (this.provider !== null) {
                ...
                if (this.orient === "horizontal") {
                    ...
                    if (this.showLabels) {
                        ...
                        if (view !== null) {
                            ...
                            view.paint(g, this.toLocation(min) - Math.round(ps.width / 2), this.labelsAlignment === "normal" ? yy + ss + this.gap : yy + this.$maxLabSize - ps.height, ps.width, ps.height, this)
                        }
                        view = this.provider.getView(this, max);
                        if (view !== null) {
                            ps = view.getPreferredSize();
                            view.paint(g, this.toLocation(max) - Math.round(ps.width / 2), this.labelsAlignment === "normal" ? yy + ss + this.gap : yy + this.$maxLabSize - ps.height, ps.width, ps.height, this)
                        }
                    ...
                    if (this.showLabels) {
                        ...
                        if (view !== null) {
                            ps = view.getPreferredSize();
                            this.paintLabel(g, this.labelsAlignment === "normal" ? xx + this.$maxLabSize - ps.width : ss + this.gap + xx, this.toLocation(min) - Math.round(ps.height / 2), ps.width, ps.height, view, min)
                        }
                        view = this.provider.getView(this, max);
                        if (view !== null) {
                            ps = view.getPreferredSize();
                            this.paintLabel(g, this.labelsAlignment === "normal" ? xx + this.$maxLabSize - ps.width : ss + this.gap + xx, this.toLocation(max) - Math.round(ps.height / 2), ps.width, ps.height, view, max)
                        }
                        if (this.labelsAlignment === "normal") {
    ...
    pkg.PointRulerPan = Class(pkg.RulerPan, [function() {
        this.$supera(arguments);
        this.$generator = new this.clazz.DeltaPointsGenerator(10)
    }, function $clazz() {
        this.PointsGenerator = Class([function $prototype() {
            this.pointValue = function(ruler, index) {
                return null
            }
        }]);
        this.DeltaPointsGenerator = Class(this.PointsGenerator, [function(delta) {
            if (arguments.length > 0) {
                this.$delta = delta
            }
        }, function $prototype() {
                    ...
                    if (this.provider !== null && this.showLabels === true) {
                        ...
                        if (view !== null) {
                            ...
                            if (this.orient === "horizontal") {
                                if (prevLabLoc === null || loc > prevLabLoc + prevPs.width) {
                                    this.paintLabel(g, loc - Math.floor(ps.width / 2), this.labelsAlignment === "normal" ? y + ss + this.gap : y, ps.width, ps.height, view, v);
                                    prevLabLoc = loc;
                                    prevPs = ps;
                                    rendered = true
                                }
                                ...
                                if (prevLabLoc === null || Math.round(loc + ps.height / 2) < prevLabLoc) {
                                    ...
                                    this.paintLabel(g, this.labelsAlignment === "normal" ? x + ss + this.gap : x, prevLabLoc, ps.width, ps.height, view, v);
                                    rendered = true
                                }
                            }
                        }
                        if (rendered === true && this.showStrokes) {
                            if (this.orient === "horizontal") {
                                if (this.labelsAlignment === "normal") {
                                    g.moveTo(loc + .5, y);
                                    g.lineTo(loc + .5, y + this.strokeSize)
                                } else {
                                    g.moveTo(loc + .5, y + this.$maxLabSize + this.gap);
                                    g.lineTo(loc + .5, y + this.$maxLabSize + this.gap + this.strokeSize)
                                }
                            } else {
                                if (this.labelsAlignment === "normal") {
                                    g.moveTo(x, loc + .5);
                                    g.lineTo(x + this.strokeSize, loc + .5)
                                } else {
                                    g.moveTo(x + this.$maxLabSize + this.gap, loc + .5);
                                    g.lineTo(x + this.$maxLabSize + this.gap + this.strokeSize, loc + .5)
                                }
                            }
                        }
                    } else {
    ...
    pkg.LinearRulerPan = Class(pkg.RulerPan, [function $prototype() {
        this.strokeStep = 2;
                    ...
                    if (i % this.longStrokeRate === 0) {
                        ...
                        if (this.provider !== null && this.showLabels) {
                            ...
                            if (view !== null) {
                                ...
                                if (prevLabLoc === null || loc > prevLabLoc + prevPs.width) {
                                    this.paintLabel(g, loc, this.labelsAlignment === "normal" ? y + 2 * ss + this.gap : y, ps.width, ps.height, view, v);
                                    prevLabLoc = loc;
                                    prevPs = ps;
                                    rendered = true
                                }
                        ...
                        if (this.showStrokes) {
                            if (this.labelsAlignment === "normal") {
                                g.moveTo(xx + .5, y);
                                g.lineTo(xx + .5, y + (rendered ? 2 * ss : ss))
                            } else {
                                g.moveTo(xx + .5, y + this.$maxLabSize + this.gap + (rendered ? 0 : ss));
                                g.lineTo(xx + .5, y + this.$maxLabSize + this.gap + 2 * ss)
                            }
                        }
                        ...
                        if (this.labelsAlignment === "normal") {
                            ...
                            g.moveTo(xx + .5, y + this.$maxLabSize + this.gap + ss);
                            g.lineTo(xx + .5, y + this.$maxLabSize + this.gap + 2 * ss)
                        }
                    }
                }
                ...
                for (i = 0; yy >= minY; i++, yy -= this.strokeStep) {
                    if (i % this.longStrokeRate === 0) {
                        ...
                        if (this.provider !== null && this.showLabels) {
                            ...
                            if (view !== null) {
                                ...
                                if (prevLabLoc === null || loc + ps.height < prevLabLoc) {
                                    this.paintLabel(g, this.labelsAlignment === "normal" ? x + 2 * ss + this.gap : x, loc, ps.width, ps.height, view, v);
                                    prevLabLoc = loc;
                                    rendered = true
                                }
                            }
                        ...
                        if (this.showStrokes) {
                            if (this.labelsAlignment === "normal") {
                                g.moveTo(x, yy + .5);
                                g.lineTo(x + (rendered ? 2 * ss : ss), yy + .5)
                            } else {
                                g.moveTo(x + this.$maxLabSize + this.gap + (rendered ? 0 : ss), yy + .5);
                                g.lineTo(x + this.$maxLabSize + this.gap + 2 * ss, yy + .5)
                            }
                        }
                    } else if (this.showStrokes) {
                        if (this.labelsAlignment === "normal") {
                            ...
                            g.moveTo(x + this.$maxLabSize + this.gap + ss, yy + .5);
                            g.lineTo(x + this.$maxLabSize + this.gap + 2 * ss, yy + .5)
                        }
                    }
                }
    ...
    pkg.Slider = Class(pkg.Panel, pkg.DecorationViews, [function(o) {
        this.views = {
            marker: null,
            gauge: null
        };
        ...
        this.toLocation = function(v) {
            return this.orient === "horizontal" ? this.ruler.toLocation(v) + this.ruler.x : this.ruler.toLocation(v) + this.ruler.y
        };
        this.getHandleView = function() {
            var h = this.orient === "horizontal" ? this.views.horHandle : this.views.verHandle;
        ...
        this.paintOnTop = function(g) {
            ...
            if (this.orient === "horizontal") {
                if (handleView !== null) {
                    handleView.paint(g, this.getHandleLoc(), top, handlePs.width, handlePs.height, this)
                }
            } else {
                if (handleView !== null) {
                    handleView.paint(g, left, this.getHandleLoc(), handlePs.width, handlePs.height, this)
                }
            }
        ...
        this.getHandleLoc = function() {
            ...
            return this.orient === "horizontal" ? this.toLocation(this.value) - Math.round(hs.width / 2) : this.toLocation(this.value) - Math.round(hs.height / 2)
        };
        ...
        this.doLayout = function(t) {
            var gaugePs = this.gauge !== null && this.gauge.isVisible ? this.gauge.getPreferredSize() : null,
                ...
                h2s = this.orient === "vertical" ? Math.round(hs.height / 2) : Math.round(hs.width / 2);
            if (this.orient === "vertical") {
                var y = this.getTop() + (this.ruler.$maxGap >= h2s ? 0 : h2s - this.ruler.$maxGap);
                this.ruler.setLocation(this.getLeft() + hs.width + this.gap, y);
                this.ruler.setSize(this.ruler.getPreferredSize().width, this.height - y - this.getBottom() - (this.ruler.$minGap >= h2s ? 0 : h2s - this.ruler.$minGap));
                if (this.gauge !== null && this.gauge.isVisible) {
                    this.gauge.setBounds(this.getLeft() + Math.floor((hs.width - gaugePs.width) / 2), this.getTop(), gaugePs.width, this.height - this.getTop() - this.getBottom())
                }
            } else {
                var x = this.getLeft() + (this.ruler.$minGap >= h2s ? 0 : h2s - this.ruler.$minGap);
                this.ruler.setLocation(x, this.getTop() + hs.height + this.gap);
                this.ruler.setSize(this.width - x - this.getRight() - (this.ruler.$maxGap >= h2s ? 0 : h2s - this.ruler.$maxGap), this.ruler.getPreferredSize().height);
                if (this.gauge !== null && this.gauge.isVisible) {
                    this.gauge.setBounds(this.getLeft(), this.getTop() + Math.floor((hs.height - gaugePs.height) / 2), this.width - this.getLeft() - this.getRight(), gaugePs.height)
                }
            }
        };
        this.calcPreferredSize = function(l) {
            ...
            if (this.ruler.isVisible === true) {
                ...
                if (this.orient === "horizontal") {
                    ...
                    ps.width = 10 * ps.width + Math.max(h2s, this.ruler.isVisible ? this.ruler.$minGap : 0) + Math.max(h2s, this.ruler.isVisible ? this.ruler.$maxGap : 0)
                } else {
                    h2s = Math.round(ps.height / 2);
                    ps.height = 10 * ps.height + Math.max(h2s, this.ruler.isVisible ? this.ruler.$minGap : 0) + Math.max(h2s, this.ruler.isVisible ? this.ruler.$maxGap : 0);
        ...
        this.pointerClicked = function(e) {
            if (e.isAction()) {
                ...
                if (x < handle.x || y < handle.y || x >= handle.x + handle.width || y >= handle.y + handle.height) {
                    if (this.getComponentAt(x, y) !== this.ruler) {
                        var l = this.orient === "horizontal" ? x - this.ruler.x : y - this.ruler.y;
        ...
        this.setRange = function(min, max, granularity) {
            if (this.getMin() !== min || this.getMax() !== max || granularity !== this.granularity) {
                ...
                this.setGranularity(arguments.length > 2 ? granularity : this.granularity);
                this.vrp()
            }
            return this
        };
    ...
    pkg.Tabs = Class(pkg.Panel, pkg.DecorationViews, [function(o) {
        ...
        this.TabView = Class(pkg.CompRender, [function(icon, caption) {
            if (arguments.length === 0) {
                caption = ""
            } else if (arguments.length === 1) {
                caption = icon;
            ...
            this.getCaptionPan().setView(new zebkit.draw.ViewSet({
                selected: r1,
                "*": r2
            ...
            this.TabPan = Class(pkg.Panel, [function() {
                this.$super();
        ...
        this.pointerMoved = function(e) {
            ...
            if (this.overTab !== i) {
                ...
                if (this.views.overTab) {
                    this.repaint(this.repaintX, this.repaintY, this.repaintWidth, this.repaintHeight)
                }
            }
        };
        this.pointerDragEnded = function(e) {
        ...
        this.paintOnTop = function(g) {
            var ts = g.$states[g.$curState];
            if (zebkit.util.isIntersect(this.repaintX, this.repaintY, this.repaintWidth, this.repaintHeight, ts.x, ts.y, ts.width, ts.height)) {
                var i = 0;
        ...
        this.drawMarker = function(g, r) {
            ...
            if (marker) {
                var bv = this.views.outTab === null || this.views.outTab === undefined ? null : this.views.outTab,
                    ...
                    top = bv ? bv.getTop() : 0;
                marker.paint(g, r.x + left, r.y + top, r.width - left - (bv === null ? 0 : bv.getRight()), r.height - top - (bv === null ? 0 : bv.getBottom()), this)
            }
        };
        this.paintTab = function(g, pageIndex) {
            ...
            v.paint(g, b.x + Math.floor((b.width - ps.width) / 2), b.y + Math.floor((b.height - ps.height) / 2), ps.width, ps.height, page)
        };
        ...
        this.doLayout = function(target) {
            ...
            for (i = 0; i < count; i++) {
                ...
                if (i === this.selectedIndex) {
                    l.setVisible(true);
                    if (b) {
                        l.setBounds(left + this.hgap, (this.orient === "top" ? top + this.repaintHeight : top) + this.vgap, this.width - left - right - 2 * this.hgap, this.height - this.repaintHeight - top - bottom - 2 * this.vgap)
                    } else {
                        l.setBounds((this.orient === "left" ? left + this.repaintWidth : left) + this.hgap, top + this.vgap, this.width - this.repaintWidth - left - right - 2 * this.hgap, this.height - top - bottom - 2 * this.vgap)
                    }
                } else {
                    l.setVisible(false)
                }
        ...
        this.recalc = function() {
            ...
            if (count > 0) {
                ...
                if (b) {
                    ...
                    this.repaintWidth = this.tabAreaWidth + (this.border !== null ? this.orient === "left" ? this.border.getLeft() : this.border.getRight() : 0)
                } else {
                    this.tabAreaWidth += 2 * this.sideSpace;
                    this.tabAreaHeight = this.sideSpace + max;
                    this.repaintWidth = this.tabAreaWidth;
                    this.repaintHeight = this.tabAreaHeight + (this.border !== null ? this.orient === "top" ? this.border.getTop() : this.border.getBottom() : 0)
                }
                if (this.selectedIndex >= 0) {
                    r = this.getTabBounds(this.selectedIndex);
                    if (b) {
                        r.height += 2 * this.sideSpace;
                        r.width += this.sideSpace + (this.border !== null ? this.orient === "left" ? this.border.getLeft() : this.border.getRight() : 0)
                    } else {
                        r.height += this.sideSpace + (this.border !== null ? this.orient === "top" ? this.border.getTop() : this.border.getBottom() : 0);
        ...
        this.getTabAt = function(x, y) {
            this.validate();
            if (x >= this.tabAreaX && y >= this.tabAreaY && x < this.tabAreaX + this.tabAreaWidth && y < this.tabAreaY + this.tabAreaHeight) {
                var tb = null;
                if (this.selectedIndex >= 0) {
        ...
        if (zebkit.instanceOf(constr, this.clazz.TabView)) {
            ...
            render.ownerChanged(this)
        }
        this.pages.splice(index * 2, 0, render, {
            x: 0,
            y: 0,
            width: 0,
            height: 0
    ...
    pkg.TextField = Class(pkg.Label, [function(render, maxCol) {
        ...
        this.shortcutFired = function(e) {
            if (e.shortcut === "SELECTALL") {
                ...
                if (e.shortcut === "PREVWORDSELECT" || e.shortcut === "NEXTWORDSELECT" || e.shortcut === "NEXTPAGESELECT" || e.shortcut === "PREVPAGESELECT") {
                    this.startSelection()
                }
                switch (e.shortcut) {
                    case "UNDO":
                    ...
                    case "NEXTPAGESELECT":
                    case "NEXTPAGE":
                        this.position.seekLineTo("down", this.pageSize());
                        break;
                    case "PREVPAGESELECT":
                    case "PREVPAGE":
                        this.position.seekLineTo("up", this.pageSize());
                        break;
                    case "NEXTWORDSELECT":
                    case "PREVWORDSELECT":
                    case "PREVWORD":
                    case "NEXTWORD":
                        {
                            var p = this.findNextWord(this.view, this.position.currentLine, this.position.currentCol, d);
                            if (p !== null) {
        ...
        this.keyPressed = function(e) {
            if (this.isFiltered(e) === false) {
                ...
                switch (e.code) {
                    case "ArrowDown":
                        position.seekLineTo("down");
                        break;
                    case "ArrowUp":
                        position.seekLineTo("up");
                        break;
                    case "ArrowLeft":
        ...
        this.isFiltered = function(e) {
            var code = e.code;
            return code === "Shift" || code === "Control" || code === "Tab" || code === "Alt" || e.altKey
        };
        ...
        this.recalc = function() {
            ...
            if (this.position.offset >= 0) {
                ...
                if (this.textAlign === "left") {
                    ...
                    this.curX = this.width - this.getRight() - this.view.getPreferredSize().width + r.font.charsWidth(l, 0, this.position.currentCol)
                }
                this.curY = this.position.currentLine * (r.getLineHeight() + r.lineIndent) + this.getTop()
            }
        ...
        this.drawCursor = function(g) {
            if (this.position.offset >= 0 && this.cursorView !== null && this.$blinkMe && this.hasFocus()) {
                if (this.textAlign === "left") {
                    this.cursorView.paint(g, this.curX, this.curY, this.cursorWidth, this.cursorHeight === 0 ? this.$lineHeight : this.cursorHeight, this)
                } else {
                    this.cursorView.paint(g, this.curX - this.cursorWidth, this.curY, this.cursorWidth, this.cursorHeight === 0 ? this.$lineHeight : this.cursorHeight, this)
                }
            }
        };
        this.pointerDragStarted = function(e) {
        ...
        this.posChanged = function(target, po, pl, pc) {
            ...
            if (position.offset >= 0) {
                ...
                var lineHeight = this.view.getLineHeight(),
                    top = this.getTop();
                this.scrollManager.makeVisible(this.textAlign === "left" ? this.curX : this.curX - this.cursorWidth, this.curY, this.cursorWidth, lineHeight);
                if (pl >= 0) {
                    if (this.startOff >= 0) {
        ...
        this.paintOnTop = function(g) {
            if (this.hint !== null && this.getMaxOffset() === 0) {
                var ps = this.hint.getPreferredSize(),
                    ...
                    xx = "left" === this.textAlign ? this.getLeft() + this.cursorWidth : this.width - ps.width - this.getRight() - this.cursorWidth;
                this.hint.paint(g, xx, yy, this.width, this.height, this)
            }
        };
        this.setHint = function(hint) {
            if (this.hint !== hint) {
                this.hint = zebkit.isString(hint) ? new this.clazz.HintRender(hint) : zebkit.draw.$view(hint);
                this.repaint()
            }
            return this
        };
        ...
        this.getStartSelection = function() {
            return this.startOff !== this.endOff ? this.startOff < this.endOff ? {
                row: this.startLine,
                col: this.startCol
            } : {
                row: this.endLine,
        ...
        this.getSelectedText = function() {
            return this.startOff !== this.endOff ? this.getSubString(this.view, this.getStartSelection(), this.getEndSelection()) : null
        };
        this.getLines = function() {
        ...
        this.focusGained = function(e) {
            ...
            if (this.isEditable === true && this.blinkingPeriod > 0) {
                ...
                }, Math.floor(this.blinkingPeriod / 3), Math.floor(this.blinkingPeriod / 3))
            }
        };
        ...
        this.repaintCursor = function() {
            if (this.curX > 0 && this.cursorWidth > 0 && (this.cursorHeight > 0 || this.$lineHeight > 0)) {
                this.repaint(this.curX + this.scrollManager.getSX(), this.curY + this.scrollManager.getSY(), this.cursorWidth, this.cursorHeight === 0 ? this.$lineHeight : this.cursorHeight)
            }
        };
        ...
        this.setPSByRowsCols = function(r, c) {
            var tr = this.view,
                w = c > 0 ? tr.font.stringWidth("W") * c : this.psWidth,
                h = r > 0 ? r * tr.getLineHeight() + (r - 1) * tr.lineIndent : this.psHeight;
        ...
        this.paint = function(g) {
            ...
            try {
                g.translate(sx, sy);
                if (this.textAlign === "left") {
                    this.view.paint(g, l, t, this.width - l - r, this.height - t - this.getBottom(), this)
                } else {
                    this.view.paint(g, this.width - r - this.view.getPreferredSize().width, t, this.width - l - r, this.height - t - this.getBottom(), this)
                }
                this.drawCursor(g)
            } catch (e) {
                g.translate(-sx, -sy);
    ...
    pkg.TextArea = Class(pkg.TextField, [function(txt) {
        if (arguments.length === 0) {
            txt = ""
        }
        this.$super(new zebkit.data.Text(txt))
    }]);
    pkg.PassTextField = Class(pkg.TextField, [function(txt, size, showLast) {
        if (arguments.length === 1) {
            showLast = false;
            size = -1;
    ...
    pkg.BaseList = Class(pkg.Panel, zebkit.util.Position.Metric, pkg.DecorationViews, [function(m, b) {
        if (arguments.length === 0) {
            m = [];
            b = false
        } else if (arguments.length === 1) {
        ...
        this.getSelected = function() {
            return this.selectedIndex < 0 ? null : this.model.get(this.selectedIndex)
        };
        ...
        this.drawViewAt = function(g, id, index) {
            if (index >= 0 && this.views.hasOwnProperty(id) && this.views[id] !== null && this.isItemSelectable(index)) {
                ...
                this.drawView(g, id, this.views[id], l.x, l.y, is.width, is.height)
            }
        };
        ...
        this.pointerReleased = function(e) {
            if (this.model !== null && this.model.count() > 0 && e.isAction() && this.position.offset !== this.selectedIndex) {
            ...
            if (this.model !== null && this.model.count() > 0) {
                switch (e.code) {
                    ...
                    case "Home":
                        ...
                        break;
                    case "ArrowRight":
                        this.position.seek(1);
                        break;
                    case "ArrowDown":
                        this.position.seekLineTo("down");
                        break;
                    case "ArrowLeft":
                        this.position.seek(-1);
                        break;
                    case "ArrowUp":
                        this.position.seekLineTo("up");
                        break;
                    case "PageUp":
                        this.position.seek(this.pageSize(-1));
                        break;
                    case "PageDown":
                        this.position.seek(this.pageSize(1));
                        break;
        ...
        this.makeItemVisible = function(index) {
            if (index >= 0 && this.scrollManager !== null) {
                ...
                if (is.width > 0 && is.height > 0) {
                    ...
                    this.scrollManager.makeVisible(l.x - this.scrollManager.getSX(), l.y - this.scrollManager.getSY(), is.width, is.height)
                }
            }
            return this
        };
    ...
    pkg.List = Class(pkg.BaseList, [function(m, b) {
        this.firstVisible = -1;
        ...
        this.Item = Class([function(value, caption) {
            this.value = value;
            if (arguments.length > 1) {
        ...
        this.ItemViewProvider = Class(zebkit.draw.BaseViewProvider, [function getView(t, i, v) {
            if (v !== null) {
            ...
            if (this.firstVisible >= 0) {
                ...
                try {
                    ...
                    for (var i = this.firstVisible; i < count; i++) {
                        ...
                        this.provider.getView(this, i, this.model.get(i)).paint(g, x + this.gap, y + this.gap, this.widths[i] - dg, this.heights[i] - dg, this);
                        y += this.heights[i];
                        if (y > yy) {
                            break
                        }
        ...
        this.vVisibility = function() {
            ...
            if (this.vArea === null) {
                ...
                if (this.visValid === false || (prev === null || prev.x !== this.vArea.x || prev.y !== this.vArea.y || prev.width !== this.vArea.width || prev.height !== this.vArea.height)) {
                    var top = this.getTop();
                    if (this.firstVisible >= 0) {
    ...
    pkg.CompList = Class(pkg.BaseList, [function(m, b) {
        this.model = this;
        this.setViewProvider(new zebkit.Dummy([function $prototype() {
        ...
        this.getItemSize = function(i) {
            return this.kids[i].isVisible === false ? {
                width: 0,
                height: 0
            } : {
        ...
        this.isItemSelectable = function(i) {
            return this.model.get(i).isVisible === true && this.model.get(i).isEnabled === true
        };
        this.catchInput = function(child) {
            if (this.isComboMode !== true) {
                var p = child;
        ...
        if (layout !== this.layout) {
            this.scrollManager = new pkg.ScrollManager(this, [function $prototype() {
                this.calcPreferredSize = function(t) {
    ...
    pkg.Combo = Class(pkg.Panel, [function(list, editable) {
        ...
        if (zebkit.instanceOf(list, pkg.BaseList) === false) {
            list = list.length > 0 && zebkit.instanceOf(list[0], pkg.Panel) ? new this.clazz.CompList(list, true) : new this.clazz.List(list, true)
        }
        this.maxPadHeight = 0;
        this.$lockListSelEvent = false;
        this.setList(list);
        this.$super();
        this.add("center", editable ? new this.clazz.EditableContentPan : new this.clazz.ReadonlyContentPan);
        this.add("right", new this.clazz.ArrowButton)
    }, function $clazz() {
        this.ContentPan = Class(pkg.Panel, [function $prototype() {
        ...
        this.ComboPadPan = Class(pkg.ScrollPan, [function $prototype() {
            this.$closeTime = 0;
            this.owner = null;
            this.childKeyPressed = function(e) {
        ...
        this.ReadonlyContentPan = Class(this.ContentPan, [function $prototype() {
            this.calcPsByContent = false;
            this.getCurrentView = function() {
                var list = this.getCombo().list,
                    selected = list.getSelected();
                return selected !== null ? list.provider.getView(list, list.selectedIndex, selected) : null
            };
            this.paintOnTop = function(g) {
                var v = this.getCurrentView();
                if (v !== null) {
                    var ps = v.getPreferredSize();
                    v.paint(g, this.getLeft(), this.getTop() + Math.floor((this.height - this.getTop() - this.getBottom() - ps.height) / 2), this.width, ps.height, this)
                }
            };
        ...
        this.EditableContentPan = Class(this.ContentPan, [function() {
            this.$super();
        ...
        this.ArrowButton = Class(pkg.ArrowButton, [function() {
        ...
        this.paint = function(g) {
            if (this.content !== null && this.selectView !== null && this.hasFocus()) {
                this.selectView.paint(g, this.content.x, this.content.y, this.content.width, this.content.height, this)
            }
        };
        this.catchInput = function(child) {
        ...
        this.pointerPressed = function(e) {
            if (e.isAction() && this.content !== null && (new Date).getTime() - this.winpad.$closeTime > 100 && e.x > this.content.x && e.y > this.content.y && e.x < this.content.x + this.content.width && e.y < this.content.y + this.content.height) {
                this.showPad()
            }
        };
        ...
        this.showPad = function() {
            ...
            if (canvas !== null) {
                ...
                this.winpad.setBounds(p.x, py + (this.adjustPadTo === null ? this.height : this.adjustPadTo.height), this.adjustPadTo === null ? this.width : this.adjustPadTo.width, ps.height);
        ...
        this.setList = function(l) {
            if (this.list !== l) {
                ...
                var $this = this;
                this.winpad = new this.clazz.ComboPadPan(this.list, [function setParent(p) {
                    this.$super(p);
                    if ($this.padShown !== undefined) {
        ...
        this.keyPressed = function(e) {
            if (this.list !== null && this.list.model !== null) {
                ...
                switch (e.code) {
                    ...
                    case "ArrowDown":
                    case "ArrowRight":
                        if (this.list.model.count() - 1 > index) {
                            this.list.select(index + 1)
                        }
                        break
                }
        ...
        this.setEditable = function(b) {
            if (this.content === null || this.content.isEditable !== b) {
                ...
                this.add(ctr, b ? new this.clazz.EditableContentPan : new this.clazz.ReadonlyContentPan)
            }
            return this
        };
        this.fired = function(src) {
    ...
    pkg.event.MenuEvent = Class(zebkit.Event, [function $prototype() {
        this.index = -1;
        this.item = null;
    ...
    pkg.MenuItem = Class(pkg.Panel, [function(c) {
        this.$super();
        if (zebkit.isString(c)) {
            ...
            if (c.checked === true || c.checked === false || c.group !== undefined) {
                ch = c.group !== undefined ? new this.clazz.Radiobox : new this.clazz.Checkbox;
        ...
        this.doLayout = function(target) {
            ...
            if (right !== null && right.isVisible === true) {
                ...
                right.setLocation(target.width - target.getRight() - right.width, t + Math.floor((eh - right.height) / 2))
            }
    ...
    pkg.Menu = Class(pkg.CompList, [function(d) {
        this.menus = {};
        ...
        this.MenuItem = Class(pkg.MenuItem, [function $clazz() {
        ...
        this.$showSubMenu = function(sub) {
            sub.setLocation(this.x + this.width - 10, this.y + this.kids[this.selectedIndex].y);
            sub.toPreferredSize();
            this.parent.add(sub);
            sub.requestFocus()
        };
        ...
        if (zebkit.isString(c)) {
            return this.$super(i, ctr, c.match(/^\-+$/) !== null ? new this.clazz.Line : new this.clazz.MenuItem(c))
        ...
        if (this.parent !== null) {
            ...
            if (this.selectedIndex >= 0) {
                ...
                if (sub !== null) {
                    ...
                    pkg.events.fire("menuItemSelected", MENU_EVENT.$fillWith(this, this.selectedIndex, this.kids[this.selectedIndex]));
    ...
    pkg.Menubar = Class(pkg.Menu, [function $clazz() {
        this.MenuItem = Class(pkg.MenuItem, [function(c) {
            this.$super(c);
            this.getSub().setVisible(false);
    ...
    pkg.PopupLayerLayout = Class(zebkit.layout.Layout, [function $prototype() {
        this.calcPreferredSize = function(target) {
            return {
                width: 0,
                height: 0
    ...
    pkg.PopupLayerMix = zebkit.Interface([function $clazz() {
        this.id = "popup"
    }, function $prototype() {
    ...
    pkg.event.WinEvent = Class(zebkit.Event, [function $prototype() {
        this.isShown = false;
        this.isActive = false;
        this.layer = null;
    ...
    pkg.WinLayerMix = zebkit.Interface([function $clazz() {
        this.id = "win"
    }, function $prototype() {
        this.activeWin = null;
        ...
        this.layerKeyPressed = function(e) {
            if (this.kids.length > 0 && e.code === "Tab" && e.shiftKey === true) {
        ...
        this.childPointerClicked = function(e) {
            if (this.kids.length > 0 && (this.activeWin === null || zebkit.layout.isAncestorOf(this.activeWin, e.source) === false)) {
                for (var i = this.kids.length - 1; i >= 0 && i >= this.topModalIndex; i--) {
                    var d = this.kids[i];
                    if (d.isVisible === true && d.isEnabled === true && d.winType !== "info" && zebkit.layout.isAncestorOf(d, e.source)) {
                        this.activate(d);
                        return true
                    }
                }
        ...
        this.activate = function(c) {
            if (c !== null && (this.kids.indexOf(c) < 0 || c.winType === "info")) {
        ...
        this.getComponentAt = function(x, y) {
            if (this.kids.length === 0) {
                ...
                for (var i = this.kids.length - 1; i >= 0 && i >= this.topModalIndex; i--) {
                    var kid = this.kids[i];
                    if (kid.isVisible && kid.winType !== "info" && x >= kid.x && y >= kid.y && x < kid.x + kid.width && y < kid.y + kid.height) {
                        return kid.getComponentAt(x - kid.x, y - kid.y)
                    }
                }
    ...
    pkg.Window = Class(pkg.StatePan, [function(s, c) {
        this.state = "inactive";
        ...
        this.CaptionPan = Class(pkg.StatePan, [function $prototype() {
            this.state = "inactive"
        }]);
        ...
        this.pointerDragStarted = function(e) {
            this.px = e.absX;
            this.py = e.absY;
            this.action = this.insideCorner(e.x, e.y) ? this.isSizeable ? SIZE_ACTION : -1 : MOVE_ACTION;
            if (this.action > 0) {
                this.dy = this.dx = 0
            }
        };
        ...
        this.getCursorType = function(target, x, y) {
            return this.isSizeable && this.insideCorner(x, y) ? pkg.Cursor.SE_RESIZE : null
        };
        this.catchInput = function(c) {
            var tp = this.caption;
            return c === tp || zebkit.layout.isAncestorOf(tp, c) && zebkit.instanceOf(c, pkg.Button) === false || this.sizer === c
        };
        ...
        this.pointerDoubleClicked = function(e) {
            var x = e.x,
                y = e.y,
                cc = this.caption;
            if (this.isSizeable === true && x > cc.x && x < cc.y + cc.width && y > cc.y && y < cc.y + cc.height) {
                if (this.prevW < 0) {
                    this.maximize()
                } else {
                    this.restore()
        ...
        this.maximize = function() {
            if (this.prevW < 0) {
                ...
                cont.setBounds(left, top, d.width - left - d.getRight(), d.height - top - d.getBottom())
            }
            return this
        };
        this.restore = function() {
            if (this.prevW >= 0) {
                this.getWinContainer().setBounds(this.prevX, this.prevY, this.prevW, this.prevH);
                this.prevW = -1
            }
            return this
        };
    ...
    pkg.Tooltip = Class(pkg.Panel, [function(content) {
        this.$super();
        if (arguments.length > 0) {
        ...
        this.Label = Class(pkg.Label, []);
        this.ImageLabel = Class(pkg.ImageLabel, []);
        this.TooltipBorder = Class(zebkit.draw.View, [function(col, size) {
            if (arguments.length > 0) {
                this.color = col
            }
            if (arguments.length > 1) {
        ...
        this.$contentPs = this.kids.length === 0 ? this.$super() : this.kids[0].getPreferredSize()
    }, function getBottom() {
    ...
    pkg.TooltipManager = Class(zebkit.ui.event.Manager, [function $prototype() {
        ...
        this.pointerEntered = function(e) {
            if (this.$target === null && (e.source.tooltip !== undefined && e.source.tooltip !== null || e.source.getTooltip !== undefined)) {
                this.$target = e.source;
                this.$targetTooltipLayer = e.source.getCanvas().getLayer("win");
                this.$tooltipX = e.x;
                this.$tooltipY = e.y;
                this.$toolTask = zebkit.util.tasksSet.run(this, this.showTooltipIn, this.showTooltipIn)
            }
        };
        this.pointerExited = function(e) {
        ...
        this.run = function(t) {
            if (this.$target !== null) {
                var ntooltip = this.$target.tooltip !== undefined && this.$target.tooltip !== null ? this.$target.tooltip : this.$target.getTooltip(this.$target, this.$tooltipX, this.$tooltipY),
                    p = null,
                    tx = 0,
                    ty = 0;
        ...
        this.pointerPressed = function(e) {
            if (this.hideTooltipByPress === true && e.pointerType === "mouse" && this.$target !== null && this.$target.hideTooltipByPress !== false && (this.$tooltip === null || this.$tooltip.winType === "info")) {
                this.stopShowingTooltip()
            }
        };
        this.pointerReleased = function(e) {
            if ((this.hideTooltipByPress === false || e.pointerType !== "mouse") && (this.$target !== null && this.$target.hideTooltipByPress !== false) && (this.$tooltip === null || this.$tooltip.winType === "info")) {
                this.stopShowingTooltip()
            }
        }
    }]);
    pkg.Spin = new Class(pkg.Panel, [function(min, max) {
        this.$super(this);
        this.step = 1;
        ...
        this.editor = null;
        this.isLooped = true;
        this.layoutComponents(new this.clazz.TextField(this, this.min, this.max), new this.clazz.IncButton, new this.clazz.DecButton)
    }, function $clazz() {
        ...
        this.TextField = Class(pkg.TextField, [function(target, min, max) {
            this.target = target;
            this.min = min;
            this.max = max;
            var $this = this;
            this.$super(new zebkit.data.SingleLineTxt([function() {
                this.$super("" + min)
            ...
            return {
                width: Math.max(font.stringWidth("" + this.max), font.stringWidth("" + this.min)),
                height: font.height
            }
...
zebkit.package("ui.tree", function(pkg, Class) {
    ...
    pkg.DefEditors = Class([function() {
        ...
        this.shouldStartEdit = function(src, e) {
            return e.id === "pointerDoubleClicked" || e.id === "keyPressed" && e.code === "Enter"
        }
    }]);
    pkg.DefViews = Class(zebkit.draw.BaseViewProvider, [function getView(tree, item) {
        return this.$super(tree, item.value)
    }]);
    pkg.BaseTree = Class(ui.Panel, ui.DecorationViews, [function(d, b) {
        if (arguments.length < 2) {
            b = true
        }
        ...
        this.vVisibility = function() {
            if (this.model === null) {
                ...
                if (nva === null) {
                    ...
                    if (this._isVal === false || (this.visibleArea === null || this.visibleArea.x !== nva.x || this.visibleArea.y !== nva.y || this.visibleArea.width !== nva.width || this.visibleArea.height !== nva.height)) {
                        this.visibleArea = nva;
                        if (this.firstVisible !== null) {
                            this.firstVisible = this.findOpened(this.firstVisible);
                            this.firstVisible = this.isOverVisibleArea(this.firstVisible) ? this.nextVisible(this.firstVisible) : this.prevVisible(this.firstVisible)
                        } else {
                            this.firstVisible = -this.scrollManager.getSY() > Math.floor(this.maxh / 2) ? this.prevVisible(this.findLast(this.model.root)) : this.nextVisible(this.model.root)
                        }
                    }
                }
            }
        ...
        this.getToggleView = function(i) {
            var v = i.kids.length > 0 ? this.getIM(i).isOpen ? this.views.expandedToggle : this.views.collapsedToggle : null;
        ...
        this.$recalc = function(x, y, parent, root, isVis) {
            ...
            if (isVis === true) {
                ...
                node.x = x;
                node.y = y;
                node.width = toggleSize.width + imageSize.width + node.viewWidth + (toggleSize.width > 0 ? this.gapx : 0) + 10 + (imageSize.width > 0 ? this.gapx : 0);
                node.height = Math.max(toggleSize.height > imageSize.height ? toggleSize.height : imageSize.height, node.viewHeight);
        ...
        this.getIconView = function(i) {
            return i.kids.length > 0 ? this.getIM(i).isOpen ? this.views.expandedSign : this.views.collapsedSign : this.views.leafSign
        };
        this.getIconSize = function(i) {
            return i.kids.length > 0 ? this.getIM(i).isOpen ? this.viewSizes.expandedSign : this.viewSizes.collapsedSign : this.viewSizes.leafSign
        };
        ...
        this.getToggleSize = function(i) {
            return this.$isOpen(i) ? this.viewSizes.expandedToggle : this.viewSizes.collapsedToggle
        };
        ...
        this.findLast = function(item) {
            return this.$isOpen(item) && item.kids.length > 0 ? this.findLast(item.kids[item.kids.length - 1]) : item
        };
        ...
        this.isVerVisible = function(item) {
            ...
            return this.visibleArea.y <= yy1 && yy1 < by || this.visibleArea.y <= yy2 && yy2 < by || this.visibleArea.y > yy1 && yy2 >= by
        };
        this.nextVisible = function(item) {
            if (item === null || this.isVerVisible(item) === true) {
                return item
            }
            var res = this.nextVisibleInBranch(item),
                parent = null;
            if (res !== null) {
                return res
            }
        ...
        this.paintBranch = function(g, root) {
            ...
            var node = this.getIM(root),
                ...
                dy = this.scrollManager.getSY();
            if (zebkit.util.isIntersect(node.x + dx, node.y + dy, node.width, node.height, this.visibleArea.x, this.visibleArea.y, this.visibleArea.width, this.visibleArea.height)) {
                ...
                if (image.width > 0) {
                    this.getIconView(root).paint(g, image.x, image.y, image.width, image.height, this)
                }
                ...
                if (this.lnColor !== null) {
                    ...
                    var yy = toggle.y + Math.floor(toggle.height / 2) + .5;
                    g.beginPath();
                    g.moveTo(toggle.x + (toggleView === null ? Math.floor(toggle.width / 2) : toggle.width - 1), yy);
                    g.lineTo(image.x, yy);
                    g.stroke()
                }
            } else {
                if (node.y + dy > this.visibleArea.y + this.visibleArea.height || node.x + dx > this.visibleArea.x + this.visibleArea.width) {
                    return false
                }
            }
        ...
        this.$y = function(item, isStart) {
            var node = this.getIM(item),
                ...
                dy = this.scrollManager.getSY(),
                y = item.kids.length > 0 ? isStart ? ty + th : ty - 1 : ty + Math.floor(th / 2);
            return y + dy < 0 ? -dy - 1 : y + dy > this.height ? this.height - dy : y
        };
        this.paintChild = function(g, root, index) {
            var b = this.$isOpen(root);
            if (root === this.firstVisible && this.lnColor !== null) {
                g.setColor(this.lnColor);
                var xx = this.getIM(root).x + Math.floor((b ? this.viewSizes.expandedToggle.width : this.viewSizes.collapsedToggle.width) / 2);
                g.beginPath();
                g.moveTo(xx + .5, this.getTop());
                g.lineTo(xx + .5, this.$y(root, false));
                g.stroke()
            }
            if (b === true && root.kids.length > 0) {
                ...
                var x = this.getIM(firstChild).x + Math.floor((this.$isOpen(firstChild) ? this.viewSizes.expandedToggle.width : this.viewSizes.collapsedToggle.width) / 2),
                    count = root.kids.length;
                if (index < count) {
                    var node = this.getIM(root),
                        y = index > 0 ? this.$y(root.kids[index - 1], true) : node.y + Math.floor((node.height + this.getIconSize(root).height) / 2);
                    for (var i = index; i < count; i++) {
                        ...
                        if (this.lnColor !== null) {
                            ...
                            g.beginPath();
                            g.moveTo(x + .5, y);
                            g.lineTo(x + .5, this.$y(child, false));
                            g.stroke();
                            y = this.$y(child, true)
                        }
                        if (this.paintBranch(g, child) === false) {
                            if (this.lnColor !== null && i + 1 !== count) {
                                ...
                                g.beginPath();
                                g.moveTo(x + .5, y);
                                g.lineTo(x + .5, this.height - this.scrollManager.getSY());
                                g.stroke()
                            }
                            return false
                        }
    ...
    var ui = pkg.cd("..");
    pkg.Tree = Class(pkg.BaseTree, [function(d, b) {
        if (arguments.length < 2) {
            b = true
        }
        ...
        this.childKeyPressed = function(e) {
            if (e.code === "Escape") {
                ...
                if (e.code === "Enter" && (zebkit.instanceOf(e.source, ui.TextField) === false || zebkit.instanceOf(e.source.view.target, zebkit.data.SingleLineTxt))) {
        ...
        this.catchScrolled = function(psx, psy) {
            ...
            this.firstVisible = this.y < psy ? this.nextVisible(this.firstVisible) : this.prevVisible(this.firstVisible);
            this.repaint()
        };
        ...
        this.paintItem = function(g, root, node, x, y) {
            if (root !== this.editedItem) {
                ...
                v.paint(g, x + this.itemGapX, y + this.itemGapY, node.viewWidth, node.viewHeight, this)
            }
        };
        ...
        this.pointerDoubleClicked = function(e) {
            if (this.se(this.pressedItem, e)) {
                ...
                if (this.selected !== null && this.getItemAt(this.firstVisible, e.x, e.y) === this.selected) {
        ...
        this.keyTyped = function(e) {
            if (this.selected !== null) {
                switch (e.key) {
                    case "+":
                        if (this.isOpen(this.selected) === false) {
                            this.toggle(this.selected)
                        }
                        break;
                    case "-":
        ...
        this.startEditing = function(item) {
            ...
            if (this.editors !== null) {
                ...
                if (editor !== null) {
                    ...
                    editor.setBounds(b.x + this.scrollManager.getSX() + this.itemGapX, b.y - Math.floor((ps.height - b.height + 2 * this.itemGapY) / 2) + this.scrollManager.getSY() + this.itemGapY, ps.width, ps.height);
                    this.add(editor);
                    editor.requestFocus();
    ...
    var ui = pkg.cd("..");
    pkg.CompTree = Class(pkg.BaseTree, [function $clazz() {
        this.Label = Class(ui.Label, [function $prototype() {
            this.canHaveFocus = true
        }]);
        this.Checkbox = Class(ui.Checkbox, []);
        this.Combo = Class(ui.Combo, [function keyPressed(e) {
            if (e.code !== "ArrowUp" && e.code !== "ArrowDown") {
                this.$super(e)
            }
        }]);
        this.TextField = Class(ui.TextField, [function invalidate() {
            this.isValid = false;
            this.cachedWidth = -1
        }]);
        ...
        this.childPointerPressed = this.childFocusGained = function(e) {
            if (this.isSelectable === true && this.$blockCIE !== true) {
                this.$blockCIE = true;
                try {
                    var item = zebkit.data.TreeModel.findOne(this.model.root, zebkit.layout.getDirectChild(this, e.source));
                    if (item !== null) {
                        this.select(item)
                    }
                } finally {
                    ...
                    if (started === 1) {
                        ...
                        if (node.y + sy < $this.height) {
                            var image = $this.getIconBounds(item),
                                x = image.x + image.width + (image.width > 0 || $this.getToggleSize(item).width > 0 ? $this.gapx : 0) + $this.scrollManager.getSX(),
        ...
        if (isVis === true) {
            var viewSize = this.getItemPreferredSize(root);
            if (this.$isMetricUpdated === false && (node.viewWidth !== viewSize.width || node.viewHeight !== viewSize.height)) {
...
zebkit.package("ui.grid", function(pkg, Class) {
    ...
    pkg.Metrics = zebkit.Interface(["abstract", function getCellsVisibility() {}, function getColWidth(col) {}, function getRowHeight(row) {}, function getPSColWidth(col) {}, function getPSRowHeight(row) {}, function setRowHeight(row, height) {}, function setColWidth(col, width) {}, function getGridRows() {}, function getGridCols() {}]);
    pkg.DefViews = Class(zebkit.draw.BaseViewProvider, [function $prototype() {
        this.background = null
    }]);
    pkg.StrippedRows = zebkit.Interface([function $prototype() {
        this.oddView = null;
        this.evenView = null;
        this.getCellColor = function(grid, row, col) {
            return row % 2 === 0 ? this.evenView : this.oddView
        }
    }]);
    pkg.DefEditors = Class([function() {
        ...
        this.TextField = Class(ui.TextField, []);
        this.Checkbox = Class(ui.Checkbox, []);
        this.Combo = Class(ui.Combo, [function padShown(src, b) {
            if (b === false) {
        ...
        this.getEditor = function(grid, row, col, v) {
            ...
            if (this.editors.hasOwnProperty(col)) {
                ...
                editor = zebkit.isBoolean(v) ? this.boolEditor : this.textEditor;
                editor.setValue(v);
                editor.setPadding(0);
    ...
    pkg.BaseCaption = Class(ui.Panel, [function(titles) {
        this.$super();
        if (arguments.length > 0) {
        ...
        this.getCursorType = function(target, x, y) {
            return this.metrics !== null && this.selectedColRow >= 0 && this.isResizable && this.metrics.isUsePsMetric === false ? this.orient === "horizontal" ? ui.Cursor.W_RESIZE : ui.Cursor.S_RESIZE : null
        };
        this.pointerDragged = function(e) {
            if (this.pxy !== null) {
                var b = this.orient === "horizontal",
                    rc = this.selectedColRow,
                    ns = (b ? this.metrics.getColWidth(rc) + e.x : this.metrics.getRowHeight(rc) + e.y) - this.pxy;
        ...
        this.pointerDragStarted = function(e) {
            if (this.metrics !== null && this.isResizable && this.metrics.isUsePsMetric === false) {
                this.calcRowColAt(e.x, e.y);
                if (this.selectedColRow >= 0) {
                    this.pxy = this.orient === "horizontal" ? e.x : e.y
                }
            }
        };
        this.pointerDragEnded = function(e) {
        ...
        this.pointerDoubleClicked = function(e) {
            if (this.pxy === null && this.metrics !== null && this.selectedColRow >= 0 && this.isAutoFit === true) {
        ...
        this.calcRowColAt = function(x, y) {
            var $this = this,
                newSelected = this.getCaptionAt(x, y, function(m, xy, xxyy, wh, i) {
                    ...
                    return xy < xxyy + $this.activeAreaSize && xy > xxyy - $this.activeAreaSize
                });
        ...
        this.getCaptionAt = function(x, y, f) {
            if (this.metrics !== null && x >= 0 && y >= 0 && x < this.width && y < this.height) {
                ...
                if (isHor && cv.fc !== null || isHor === false && cv.fr !== null) {
                    var gap = m.lineSize,
                        xy = isHor ? x : y,
                        xxyy = isHor ? cv.fc[1] - this.x + m.getXOrigin() : cv.fr[1] - this.y + m.getYOrigin();
                    for (var i = isHor ? cv.fc[0] : cv.fr[0]; i <= (isHor ? cv.lc[0] : cv.lr[0]); i++) {
                        var wh = isHor ? m.getColWidth(i) : m.getRowHeight(i);
                        if (arguments.length > 2 && f(m, xy, xxyy, wh, i) || arguments.length < 3 && xy > xxyy && xy < xxyy + wh) {
                            return i
                        }
                        xxyy += wh + gap
                    }
        ...
        if (p === null || zebkit.instanceOf(p, pkg.Metrics)) {
            ...
            if (this.constraints !== null) {
                this.orient = this.constraints === "top" || this.constraints === "bottom" ? "horizontal" : "vertical"
            }
        }
    }]).events("captionResized", "captionResizeSelected");
    var ui = pkg.cd("..");
    pkg.CaptionViewProvider = Class(pkg.DefViews, [function $prototype() {
        this.meta = null;
        ...
        this.getXAlignment = function(target, rowcol) {
            return this.meta === null || this.meta.hasOwnProperty(rowcol) === false ? null : this.meta[rowcol].ax
        };
        this.getYAlignment = function(target, rowcol) {
            return this.meta === null || this.meta.hasOwnProperty(rowcol) === false ? null : this.meta[rowcol].ay
        };
        this.getCellBackground = function(target, rowcol) {
            return this.meta === null || this.meta.hasOwnProperty(rowcol) === false ? null : this.meta[rowcol].bg
        };
    ...
    pkg.GridCaption = Class(pkg.BaseCaption, [function(titles, render) {
        this.titles = {};
        ...
        this.getTitle = function(rowcol) {
            return this.titles.hasOwnProperty(rowcol) ? this.titles[rowcol] : null
        };
        this.calcPreferredSize = function(l) {
            return {
                width: this.psW,
        ...
        this.getCaptionPS = function(rowcol) {
            ...
            return v !== null ? this.orient === "horizontal" ? v.getPreferredSize().width : v.getPreferredSize().height : 0
        };
        this.paintOnTop = function(g) {
            if (this.metrics !== null) {
                var cv = this.metrics.getCellsVisibility();
                if (cv.fc !== null && cv.lc !== null && this.orient === "horizontal" || cv.fr !== null && cv.lr !== null && this.orient === "vertical") {
                    var isHor = this.orient === "horizontal",
                        ...
                        bottom = this.getBottom(),
                        right = this.getRight(),
                        x = isHor ? cv.fc[1] - this.x + this.metrics.getXOrigin() : left,
                        y = isHor ? top : cv.fr[1] - this.y + this.metrics.getYOrigin(),
                        size = isHor ? this.metrics.getGridCols() : this.metrics.getGridRows();
                    for (var i = isHor ? cv.fc[0] : cv.fr[0]; i <= (isHor ? cv.lc[0] : cv.lr[0]); i++) {
                        var ww = isHor ? this.metrics.getColWidth(i) : this.width - left - right,
                            hh = isHor ? this.height - top - bottom : this.metrics.getRowHeight(i),
                        ...
                        if (v !== null) {
                            ...
                            var ps = v.getPreferredSize(),
                                vx = xa === "center" ? Math.floor((ww - ps.width) / 2) : xa === "right" ? ww - ps.width - (i === size - 1 ? right : 0) : i === 0 ? left : 0,
                                vy = ya === "center" ? Math.floor((hh - ps.height) / 2) : ya === "bottom" ? hh - ps.height - (i === size - 1 ? bottom : 0) : i === 0 ? top : 0;
                            if (bg !== null) {
                                if (isHor) {
    ...
    pkg.LeftGridCaption = Class(pkg.GridCaption, [function $prototype() {
        this.constraints = "left"
    }]);
    var ui = pkg.cd("..");
    pkg.CompGridCaption = Class(pkg.BaseCaption, [function(titles) {
        if (arguments.length === 0) {
            this.$super()
        } else {
            this.$super(titles)
        ...
        this.Layout = Class(zebkit.layout.Layout, [function $prototype() {
            this.doLayout = function(target) {
                var m = target.metrics,
                    b = target.orient === "horizontal",
                    top = target.getTop(),
                    left = target.getLeft(),
                    wh = b ? target.height - top - target.getBottom() : target.width - left - target.getRight(),
                    xy = (b ? left + m.getXOrigin() : top + m.getYOrigin()) + m.lineSize;
                for (var i = 0; i < target.kids.length; i++) {
                    var kid = target.kids[i],
                        cwh = b ? m.getColWidth(i) : m.getRowHeight(i);
                    if (kid.isVisible === true) {
                        if (b) {
        ...
        var clazz = this;
        this.TitlePan = Class(ui.Panel, [function(content) {
            this.$super();
            ...
            if (this.isSortable === true) {
                var f = this.sortState === 1 ? zebkit.data.ascent : zebkit.data.descent,
        ...
        this.getCaptionPS = function(rowcol) {
            return rowcol < this.kids.length ? this.orient === "horizontal" ? this.kids[rowcol].getPreferredSize().width : this.kids[rowcol].getPreferredSize().height : 0
        }
    ...
    pkg.LeftCompGridCaption = Class(pkg.CompGridCaption, [function $prototype() {
        this.constraints = "left"
    }]);
    var ui = pkg.cd("..");
    pkg.CellSelectMode = Class([function(target) {
        this.target = target
    }, function $prototype() {
        this.target = null;
        this.selectedRow = -1;
        ...
        this.isSelected = function(row, col) {
            return row >= 0 && row === this.selectedRow && col >= 0 && col === this.selectedCol
        };
    ...
    pkg.RowSelectMode = Class(pkg.CellSelectMode, [function $prototype() {
        this.isSelected = function(row, col) {
    ...
    pkg.ColSelectMode = Class(pkg.CellSelectMode, [function $prototype() {
        this.isSelected = function(row, col) {
    ...
    pkg.Grid = Class(ui.Panel, zebkit.util.Position.Metric, pkg.Metrics, ui.DecorationViews, [function(model) {
        if (arguments.length === 0) {
        ...
        this.colVisibility = function(col, x, d, b) {
            ...
            if (cols === 0) {
                ...
                return b ? null : d > 0 ? [col - 1, x] : [0, this.$initialCellX()]
            }
        };
        this.rowVisibility = function(row, y, d, b) {
            ...
            if (rows === 0) {
                ...
                return b ? null : d > 0 ? [row - 1, y] : [0, this.$initialCellY()]
            }
        };
        this.vVisibility = function() {
            var va = ui.$cvp(this, {});
            if (va === null) {
                this.visibleArea = null;
                this.visibility.fr = null
            } else {
                if (this.visibleArea === null || va.x !== this.visibleArea.x || va.y !== this.visibleArea.y || va.width !== this.visibleArea.width || va.height !== this.visibleArea.height) {
        ...
        this.makeVisible = function(row, col) {
            var top = this.getTop() + this.getTopCaptionHeight(),
                ...
                o = ui.calcOrigin(this.getColX(col), this.getRowY(row), this.getLineSize(row) > 1 ? this.colWidths[col] + this.lineSize : this.psWidth_, this.rowHeights[row] + this.lineSize, this.scrollManager.getSX(), this.scrollManager.getSY(), this, top, left, this.getBottom(), this.getRight());
        ...
        this.$se = function(row, col, e) {
            if (row >= 0) {
                this.stopEditing(true);
                if (this.editors !== null && this.editors.shouldStart(this, row, col, e)) {
        ...
        this.childPointerEntered = this.childPointerExited = this.childPointerReleased = this.childPointerReleased = this.childPointerPressed = this.childKeyReleased = this.childKeyTyped = this.childKeyPressed = function(e) {
            if (this.editingRow >= 0) {
                if (this.editors.shouldCancel(this, this.editingRow, this.editingCol, e)) {
                    this.stopEditing(false)
                } else {
                    if (this.editors.shouldFinish(this, this.editingRow, this.editingCol, e)) {
                        this.stopEditing(true)
                    }
                }
            }
            ...
            if (this.drawCaptionLines && (this.drawHorLines === true || this.drawVerLines === true)) {
                ...
                if (this.leftCaption !== null && this.leftCaption.isVisible) {
                    ...
                    var sx = this.leftCaption.x - this.lineSize,
                        ...
                        minY = this.topCaption !== null && this.topCaption.isVisible ? this.topCaption.y + this.topCaption.height : this.getTop();
                    g.moveTo(this.leftCaption.x - this.lineSize / 2, this.getTop());
                    g.lineTo(this.leftCaption.x - this.lineSize / 2, Math.min(this.leftCaption.y + this.leftCaption.height, this.height - this.getBottom()));
                ...
                if (this.topCaption !== null && this.topCaption.isVisible) {
                    ...
                    var sy = this.topCaption.y - this.lineSize,
                        minX = this.leftCaption !== null && this.leftCaption.isVisible ? this.leftCaption.x + this.leftCaption.width : this.getLeft(),
                        x = v.fc[1] - this.lineSize / 2 + this.scrollManager.getSX();
                    g.moveTo(this.topCaption.x - this.getLeftCaptionWidth(), sy + this.lineSize / 2);
                    g.lineTo(Math.min(this.topCaption.x + this.topCaption.width, this.width - this.getRight()), sy + this.lineSize / 2);
        ...
        this.stopEditing = function(applyData) {
            if (this.editors !== null && this.editingRow >= 0 && this.editingCol >= 0) {
                try {
                    ...
                    if (applyData) {
                        this.setEditedData(this.editingRow, this.editingCol, this.editors.fetchEditedValue(this, this.editingRow, this.editingCol, data, this.editor))
                    }
            ...
            if (this.position !== null) {
                switch (e.code) {
                    ...
                    case "ArrowDown":
                        ...
                        break;
                    case "PageUp":
                        this.position.seekLineTo("up", this.pageSize(-1));
                        break;
                    case "PageDown":
                        this.position.seekLineTo("down", this.pageSize(1));
                        break;
                    case "End":
                        if (e.ctrlKey) {
        ...
        this.isSelected = function(row, col) {
            return this.selectMode === null ? false : this.selectMode.isSelected(row, col)
        };
        ...
        this.repaintCells = function(r1, c1, r2, c2) {
            ...
            if (r1 >= 0 && c1 >= 0 && r1 < rows && c1 < cols) {
                ...
                var x1 = this.getColX(c1),
                    ...
                    y1 = this.getRowY(r1),
                    y2 = (r1 === r2 ? y1 + 1 : this.getRowY(r2)) + this.rowHeights[r2];
                this.repaint(x1 + this.scrollManager.getSX(), y1 + this.scrollManager.getSY(), x2 - x1, y2 - y1)
            }
            return this
        };
        ...
        this.doLayout = function(target) {
            var topHeight = this.topCaption !== null && this.topCaption.isVisible === true ? this.topCaption.getPreferredSize().height : 0,
                leftWidth = this.leftCaption !== null && this.leftCaption.isVisible === true ? this.leftCaption.getPreferredSize().width : 0,
                topY = this.getTop(),
                leftX = this.getLeft();
            if (topHeight > 0) {
                topY += this.lineSize
            ...
            if (this.topCaption !== null) {
                this.topCaption.setBounds(leftX + leftWidth, topY, Math.min(target.width - this.getLeft() - this.getRight() - leftWidth, this.psWidth_), topHeight)
            }
            if (this.leftCaption !== null) {
                this.leftCaption.setBounds(leftX, topY + topHeight, leftWidth, Math.min(target.height - this.getTop() - this.getBottom() - topHeight, this.psHeight_))
            }
            if (this.stub !== null && this.stub.isVisible === true) {
                if (leftWidth > 0 && topHeight > 0) {
                    this.stub.setBounds(leftX, topY, leftWidth, topHeight)
                } else {
                    this.stub.setSize(0, 0)
                }
            }
            if (this.editors !== null && this.editor !== null && this.editor.parent === this && this.editor.isVisible === true) {
                ...
                this.editor.setBounds(x + this.scrollManager.getSX(), y + this.scrollManager.getSY(), w, h)
            }
        };
        this.canHaveFocus = function() {
        ...
        this.calcPreferredSize = function(target) {
            return {
                width: this.psWidth_ + (this.leftCaption !== null && this.leftCaption.isVisible === true ? this.leftCaption.getPreferredSize().width : 0),
                height: this.psHeight_ + (this.topCaption !== null && this.topCaption.isVisible === true ? this.topCaption.getPreferredSize().height : 0)
            }
        };
                ...
                if (y + this.rowHeights[i] > cy) {
                    ...
                    for (var j = this.visibility.fc[0]; j <= this.visibility.lc[0]; j++) {
                        if (this.isSelected(i, j) === true) {
                            ...
                            var bg = this.provider.getCellColor !== undefined ? this.provider.getCellColor(this, i, j) : this.provider.background;
                            if (bg !== null) {
                        ...
                        var v = i === this.editingRow && j === this.editingCol ? null : this.provider.getView(this, i, j, this.model.get(i, j));
                        if (v !== null) {
                            ...
                            if (res.width > 0 && res.height > 0) {
                                var ax = this.provider.getXAlignment !== undefined ? this.provider.getXAlignment(this, i, j) : this.defXAlignment,
                                    ay = this.provider.getYAlignment !== undefined ? this.provider.getYAlignment(this, i, j) : this.defYAlignment,
                                    vw = w,
                                    vh = h,
                                    xx = xv,
                                    yy = yv,
                                    id = -1,
                                    ps = ax !== null || ay !== null ? v.getPreferredSize(vw, vh) : null;
                                if (ax !== null) {
                                    xx = xv + (ax === "center" ? Math.floor((w - ps.width) / 2) : ax === "right" ? w - ps.width : 0);
                                    vw = ps.width
                                }
                                if (ay !== null) {
                                    yy = yv + (ay === "center" ? Math.floor((h - ps.height) / 2) : ay === "bottom" ? h - ps.height : 0);
                                    vh = ps.height
                                }
        ...
        this.$getPosMarker = function() {
            return this.hasFocus() ? this.views.marker === undefined ? null : this.views.marker : this.views.offmarker === undefined ? null : this.views.offmarker
        };
        this.paintPosMarker = function(g) {
            if (this.position !== null && this.position.offset >= 0) {
                ...
                if (view !== null) {
                    if (this.navigationMode === "row") {
                        if (row >= v.fr[0] && row <= v.lr[0]) {
                            view.paint(g, v.fc[1], this.getRowY(row), v.lc[1] - v.fc[1] + this.colWidths[v.lc[0]], this.rowHeights[row], this)
                        }
                    } else if (this.navigationMode === "cell") {
                        if (col >= v.fc[0] && col <= v.lc[0] && row >= v.fr[0] && row <= v.lr[0]) {
                            view.paint(g, this.getColX(col), this.getRowY(row), this.colWidths[col], this.rowHeights[row], this)
                        }
                    } else if (this.navigationMode === "col") {
                        if (col >= v.fc[0] && col <= v.lc[0]) {
                            view.paint(g, this.getColX(col), v.fr[1], this.colWidths[col], v.lr[1] - v.fr[1] + this.rowHeights[v.lr[0]], this)
                        }
                    }
                }
            }
        ...
        this.paintCellSelection = function(g, row, col, x, y) {
            if (this.editingRow < 0) {
                var v = ui.focusManager.focusOwner === this ? this.views.focusOnSelect : this.views.focusOffSelect;
                if (v !== null && v !== undefined) {
        ...
        this.getPSSize = function(rowcol, b) {
            if (this.isUsePsMetric === true) {
                ...
                var max = 0,
                    count = b ? this.getGridCols() : this.getGridRows();
                for (var j = 0; j < count; j++) {
                    var r = b ? rowcol : j,
                        c = b ? j : rowcol,
                ...
                return max + (b ? this.cellInsetsTop + this.cellInsetsBottom : this.cellInsetsLeft + this.cellInsetsRight)
            }
        };
        ...
        this.setCellPaddings = function(t, l, b, r) {
            if (t !== this.cellInsetsTop || l !== this.cellInsetsLeft || b !== this.cellInsetsBottom || r !== this.cellInsetsRight) {
            ...
            if (this.editors !== null) {
                ...
                if (editor !== null) {
                    ...
                    if (editor.isPopupEditor === true) {
                        var p = zebkit.layout.toParentOrigin(this.getColX(col) + this.scrollManager.getSX(), this.getRowY(row) + this.scrollManager.getSY(), this);
        ...
        this.setLeftCaption = function() {
            ...
            this.add("left", this.$hasPanelIn(a) ? new pkg.CompGridCaption(a) : new pkg.GridCaption(a));
            return this
        };
        this.setTopCaption = function() {
            ...
            var a = Array.prototype.slice.call(arguments);
            this.add("top", this.$hasPanelIn(a) ? new pkg.CompGridCaption(a) : new pkg.GridCaption(a));
            return this
        };
    ...
    var ui = pkg.cd("..");
    pkg.GridStretchPan = Class(ui.Panel, [function(grid) {
        this.$super(this);
        this.grid = grid;
        this.$widths = [];
        this.$prevWidth = 0;
        ...
        this.calcPreferredSize = function(target) {
            this.recalcPS();
            return target.kids.length === 0 || target.grid.isVisible === false ? {
                width: 0,
                height: 0
            } : {
        ...
        this.doLayout = function(target) {
            ...
            if (target.kids.length > 0) {
                ...
                if (grid.isVisible === true) {
                    grid.setBounds(left, top, target.width - left - target.getRight(), target.height - top - target.getBottom());
        ...
        this.getMinWidth = function() {
            return zebkit.instanceOf(this.grid.topCaption, pkg.BaseCaption) ? this.grid.topCaption.minSize : 10
        };
        ...
        this.recalcPS = function() {
            ...
            if (grid !== null && grid.isVisible === true) {
                var p = this.parent,
                    ...
                    taWidth = isScr ? p.width - p.getLeft() - p.getRight() - this.getRight() - this.getLeft() : this.width - this.getRight() - this.getLeft(),
                    taHeight = isScr ? p.height - p.getTop() - p.getBottom() - this.getBottom() - this.getTop() : this.height - this.getBottom() - this.getTop();
                ...
                if (this.$strPs === null || this.$prevWidth !== taWidth) {
                    ...
                    if (isScr === true && p.height > 0 && (p.vBar !== undefined || p.vBar === null) && p.autoHide === false && taHeight < this.$strPs.height) {
...
zebkit.package("ui.design", function(pkg, Class) {
    ...
    pkg.ShaperBorder = Class(zebkit.draw.View, [function(color, gap) {
        if (arguments.length > 0) {
            this.color = color;
            if (arguments.length > 1) {
                this.gap = gap
        ...
        this.paint = function(g, x, y, w, h, d) {
            ...
            g.fill();
            g.beginPath();
            g.rect(x + Math.floor(this.gap / 2) + .5, y + Math.floor(this.gap / 2) + .5, w - this.gap, h - this.gap);
            g.stroke()
        };
        this.detectAt = function(target, x, y) {
            ...
            return contains(x, y, target.width - this.gap, my, this.gap, this.gap) ? "right" : "none"
        }
    }]);
    pkg.ShaperPan = Class(ui.Panel, [function(t) {
        ...
        this.ShaperBorderSet = Class(zebkit.draw.ViewSet, [function() {
            this.$supera(arguments);
        ...
        this.keyPressed = function(e) {
            if (this.kids.length > 0) {
                var dx = e.code === "ArrowLeft" ? -1 : e.code === "ArrowRight" ? 1 : 0,
                    ...
                    y = this.y + dy;
                if (e.shiftKey) {
                    var minW = this.border !== null ? this.border.getLeft() + this.border.getRight() : 10,
                        minH = this.border !== null ? this.border.getTop() + this.border.getBottom() : 10;
                    if (this.isResizeEnabled === true && w > minW && h > minH) {
                        this.setSize(w, h)
                    }
                } else {
                    if (this.isMoveEnabled) {
                        if (x + this.width / 2 > 0 && y + this.height / 2 > 0 && x < this.parent.width - this.width / 2 && y < this.parent.height - this.height / 2) {
                            this.setLocation(x, y)
                        }
                    }
                }
        ...
        this.pointerDragStarted = function(e) {
            ...
            if (this.isResizeEnabled || this.isMoveEnabled) {
                ...
                if (this.isMoveEnabled === true || t !== "center" || (this.isResizeEnabled === true || t === "center")) {
                    this.$state = {
                        top: t === "top" || t === "topLeft" || t === "topRight" ? 1 : 0,
        ...
        this.setBounds(d.x - left, d.y - top, d.width + left + this.getRight(), d.height + top + this.getBottom());
        this.$super(i, "center", d)
    }]);
    pkg.FormTreeModel = Class(zebkit.data.TreeModel, [function(target) {
...
zebkit.package("web", function(pkg, Class) {
    "use strict";
    pkg.$deviceRatio = window.devicePixelRatio !== undefined ? window.devicePixelRatio : window.screen.deviceXDPI !== undefined ? window.screen.deviceXDPI / window.screen.logicalXDPI : 1;
    ...
    pkg.$viewPortSize = function() {
        var ws = pkg.$windowSize(),
            body = document.body,
            css = ["margin-left", "margin-right", "margin-top", "margin-bottom", "padding-left", "padding-right", "padding-top", "padding-bottom", "border-left-width", "border-right-width", "border-top-width", "border-bottom-width"];
    ...
    pkg.$measure = function(e, cssprop) {
        ...
        return value === null || value === "" ? 0 : parseInt(/(^[0-9\.]+)([a-z]+)?/.exec(value)[1], 10)
    };
    pkg.$contains = function(element) {
        return document.contains !== undefined && document.contains(element) || document.body.contains !== undefined && document.body.contains(element)
    };
    pkg.$isInsideElement = function(element, pageX, pageY) {
        var r = element.getBoundingClientRect();
        return r !== null && pageX >= r.left && pageY >= r.top && pageX <= r.right - 1 && pageY <= r.bottom - 1
    };
    ...
    pkg.$createBlockedElement = function() {
        ...
        be.onmouseup = be.onmousedown = be.onmouseout = be.onmouseover = be.onmousemove = be.onkeydown = be.onkeypress = be.onkeyup = pkg.$eventsBlackHole;
        var events = ["touchstart", "touchend", "touchmove", "pointerdown", "pointerup", "pointermove", "pointerenter", "pointerleave"];
    ...
    pkg.$canvas = function(c, w, h, forceResize) {
        var cs = window.getComputedStyle(c, null),
            ...
            ctx = c.getContext("2d"),
            updateRatio = false;
        if (isNaN(parseInt(c.style.width)) || isNaN(parseInt(c.style.height))) {
            c.style.width = "" + cw + "px";
        ...
        if (ctx.$ratio === undefined) {
            ctx.$ratio = ctx.webkitBackingStorePixelRatio || ctx.mozBackingStorePixelRatio || ctx.msBackingStorePixelRatio || ctx.backingStorePixelRatio || ctx.backingStorePixelRatio || 1;
        ...
        } else if (c.width != cw || c.height != ch || forceResize === true) {
            c.width = cw;
            c.height = ch
        }
    ...
    pkg.Clipboard = Class(zebkit.ui.event.Clipboard, [function(triggerKeyCode) {
        ...
        if (arguments.length > 0 && triggerKeyCode !== null) {
            ...
            this.triggerKeyCode = zebkit.isMacOS ? "MetaLeft" : "Control"
        }
        if (this.triggerKeyCode !== null) {
            ...
            this.$clipboard.oncopy = function(ee) {
                var dest = $this.getDestination();
                if (dest !== null && dest.clipCopy !== undefined) {
                    var v = dest.clipCopy();
            ...
            if (zebkit.isFF === true) {
                ...
                this.$clipboard.onpaste = function(ee) {
                    var dest = $this.getDestination();
                    if (dest !== null && dest.clipPaste !== undefined) {
                        var txt = ee.clipboardData === undefined ? window.clipboardData.getData("Text") : ee.clipboardData.getData("text/plain");
                        dest.clipPaste(txt);
                        if ($this.clipPaste !== undefined) {
    ...
    var PI4 = Math.PI / 4,
        ...
        LMOUSE = "lmouse",
        RMOUSE = "rmouse";
    pkg.PointerEvent = Class(zebkit.ui.event.PointerEvent, [function $prototype() {
        this.isAction = function() {
        ...
        this.$fillWith = function(identifier, e) {
            ...
            this.pressure = e.pressure !== undefined ? e.pressure : .5
        };
        this.getTouches = function() {
            var touches = [],
                i = 0;
    ...
    var ME_STUB = new pkg.PointerEvent,
        TOUCH_STUB = new pkg.PointerEvent,
        POINTER_STUB = new pkg.PointerEvent;
    ME_STUB.pointerType = "mouse";
    TOUCH_STUB.pointerType = "touch";
    POINTER_STUB.pointerType = "unknown";

    function $cleanDragFix() {
        if ($tmpWinMouseMoveListener !== null && $pointerPressedEvents.hasOwnProperty(LMOUSE) === false && $pointerPressedEvents.hasOwnProperty(RMOUSE) === false) {
    ...
    pkg.PointerEventUnifier = Class([function $clazz() {
            ...
            try {
                ...
                if (mp.isDragged === true) {
                    ...
                    if (mp.pressPageY === stub.pageY && mp.pressPageX === stub.pageX) {
                        if ($lastPointerReleased !== null && $lastPointerReleased.identifier === id && (new Date).getTime() - $lastPointerReleased.time <= pkg.doubleClickDelta) {
                            destination.$pointerDoubleClicked(stub)
                        } else {
                            if (mp.group === stub.touchCounter) {
        ...
        element.onmousedown = function(e) {
            if (e.button !== 0 && e.button !== 2 || $this.$touchedAt(e.pageX, e.pageY, 0)) {
                e.preventDefault()
            } else {
        ...
        element.onmouseout = function(e) {
            var id = e.button === 0 ? LMOUSE : RMOUSE;
            if ($pointerPressedEvents.hasOwnProperty(id) === false) {
                if ($enteredElement !== null && (e.relatedTarget !== null && e.relatedTarget !== element && element.contains(e.relatedTarget) === false)) {
                    $enteredElement = null;
                    ME_STUB.$fillWith("mouse", e);
                ...
                var mp = $pointerPressedEvents[id];
                if ($tmpWinMouseMoveListener === null && e.relatedTarget !== null && element.contains(e.relatedTarget) === false) {
        ...
        if ("onpointerdown" in window || "onmspointerdown" in window) {
            var names = "onpointerdown" in window ? ["pointerdown", "pointerup", "pointermove", "pointerenter", "pointerleave"] : ["MSPointerDown", "MSPointerUp", "MSPointerMove", "MSPointerEnter", "MSPointerLeave"];
            ...
            element.addEventListener("touchmove", function(e) {
                ...
                for (var i = 0; i < mt.length; i++) {
                    ...
                    if ($pointerPressedEvents.hasOwnProperty(nmt.identifier)) {
                        ...
                        if (t.pageX !== Math.round(nmt.pageX) || t.pageY !== Math.round(nmt.pageY)) {
    ...
    pkg.MouseWheelSupport = Class([function(element, destination) {
        var META = this.clazz.$META;
        for (var k in META) {
            if (META[k].test()) {
                var $wheelMeta = META[k],
                    $clazz = this.clazz;
                element.addEventListener(k, function(e) {
                    ...
                    if (destination.$doScroll(Math.floor(dx), Math.floor(dy), "wheel")) {
                        e.preventDefault()
                    }
                }, false);
                break
    ...
    var CODES = {
            ...
            Minus: {
                keyCode: zebkit.isFF ? 173 : 189
            },
            Equal: {
                keyCode: zebkit.isFF ? 61 : 187
            },
            NumpadEnter: {
                map: "Enter"
            },
    ...
    $initializeCodesMap();
    pkg.KeyEvent = Class(zebkit.ui.event.KeyEvent, [function $prototype() {
        this.$fillWith = function(e) {
            ...
            if (this.code === "Enter" || this.code === "Space" || this.code === "Tab") {
                ...
                this.key = e.charCode > 0 && keyCode >= 32 ? String.fromCharCode(e.charCode) : null
            } else {
    ...
    pkg.KeyEventUnifier = Class([function(element, destination) {
        var $this = this;
        element.onkeydown = function(e) {
            ...
            KEY_DOWN_EVENT.timeStamp = ts;
            if (KEY_DOWN_EVENT.code === code && e.metaKey !== true && ts - pts < 1e3) {
            ...
            if (KEY_DOWN_EVENT.code === "MetaLeft") {
                ...
                } else if (KEY_DOWN_EVENT.code === "Space" || KEY_DOWN_EVENT.code === "Enter" || KEY_DOWN_EVENT.code === "Tab") {
        ...
        element.onkeypress = function(e) {
            ...
            if (e.metaKey !== true) {
                KEY_PRESS_EVENT.$fillWith(e);
                KEY_PRESS_EVENT.code = KEY_DOWN_EVENT.code;
                KEY_PRESS_EVENT.repeat = KEY_DOWN_EVENT.repeat;
                if (KEY_PRESS_EVENT.code !== "Space" && KEY_PRESS_EVENT.code !== "Enter" && KEY_PRESS_EVENT.code !== "Tab" && KEY_PRESS_EVENT.code !== "ContextMenu") {
...
zebkit.package("ui.web", function(pkg, Class) {
    "use strict";
    pkg.CursorManager = Class(zebkit.ui.event.CursorManager, [function $prototype() {
        this.$isFunc = false;
        this.source = this.target = null;
        this.pointerMoved = function(e) {
            if (this.$isFunc === true) {
                this.cursorType = this.source.getCursorType(this.source, e.x, e.y);
                this.target.style.cursor = this.cursorType === null ? "default" : this.cursorType
            }
        };
        this.pointerEntered = function(e) {
            if (e.source.cursorType !== undefined && e.source.cursorType !== null || e.source.getCursorType !== undefined) {
                this.$isFunc = typeof e.source.getCursorType === "function";
                this.target = e.target;
                this.source = e.source;
                this.cursorType = this.$isFunc === true ? this.source.getCursorType(this.source, e.x, e.y) : this.source.cursorType;
                this.target.style.cursor = this.cursorType === null ? "default" : this.cursorType
            }
        };
        this.pointerExited = function(e) {
    ...
    var ui = pkg.cd("..");
    pkg.HtmlElement = Class(ui.Panel, [function(e) {
        if (arguments.length === 0) {
            e = "div"
        }
        if (zebkit.isString(e)) {
            ...
            e.style.fontSize = this.clazz.$bodyFontSize
        }
        ...
        var $store = ["paddingTop", "paddingLeft", "paddingBottom", "paddingRight", "border", "borderStyle", "borderWidth", "borderTopStyle", "borderTopWidth", "borderBottomStyle", "borderBottomWidth", "borderLeftStyle", "borderLeftWidth", "borderRightStyle", "visibility", "borderRightWidth", "width", "height", "position"];
        this.recalc = function() {
            if (this.layout === this) {
                var e = this.element,
                    vars = {},
    ...
    pkg.HtmlElementMan = Class(zebkit.ui.event.Manager, [function $prototype() {
        function $isInInvisibleState(c) {
            if (c.isVisible === false || c.$container.parentNode === null || c.width <= 0 || c.height <= 0 || c.parent === null || zebkit.web.$contains(c.$container) === false) {
                return true
            }
            var p = c.parent;
        ...
        function $resolveDOMParent(c) {
            ...
            if (parentElement !== null && c.$container.parentNode === null) {
                ...
                if (parentElement !== null && c.$container.parentNode !== null && c.$container.parentNode !== parentElement) {
        ...
        this.compShown = function(e) {
            ...
            if (c.isDOMElement === true) {
                c.$container.style.visibility = c.isVisible === false || $isInInvisibleState(c) ? "hidden" : "visible"
    ...
    if (zebkit.ui.event.FocusManager !== undefined) {
        zebkit.ui.event.FocusManager.extend([function requestFocus(c) {
            this.$super(c);
            var canvas = null;
    ...
    var ui = pkg.cd("..");
    pkg.HtmlCanvas = Class(pkg.HtmlElement, [function(e) {
        ...
        this.$ContextMethods = {
            ...
            save: function() {
                this.$curState++;
                var c = this.$states[this.$curState],
                    cc = this.$states[this.$curState - 1];
                c.x = cc.x;
                c.y = cc.y;
                c.width = cc.width;
                c.height = cc.height;
    ...
    pkg.HtmlWindow = Class(pkg.HtmlCanvas, [function(content) {
        this.$super();
        if (arguments.length === 0) {
    ...
    pkg.HtmlButton = Class(pkg.HtmlElement, [function(c) {
        this.$super("button");
    ...
    pkg.HtmlFocusableElement = Class(pkg.HtmlElement, [function $prototype() {
        this.$getElementRootFocus = function() {
            return this.element
        }
    }]);
    pkg.HtmlTextInput = Class(pkg.HtmlFocusableElement, [function(text, e) {
        if (text === null) {
            text = ""
        }
        this.$super(e);
    ...
    pkg.HtmlTextField = Class(pkg.HtmlTextInput, [function(text) {
        this.$super(text, "input");
        this.element.setAttribute("type", "text")
    }]);
    pkg.HtmlTextArea = Class(pkg.HtmlTextInput, [function(text) {
    ...
    pkg.HtmlLink = Class(pkg.HtmlElement, [function(text, href) {
        this.$super("a");
    ...
    pkg.HtmlScrollContent = Class(pkg.HtmlElement, [function(t) {
        this.$super();
    ...
    pkg.RootLayer = Class(pkg.HtmlLayer, ui.RootLayerMix, [function $clazz() {
        this.layout = new zebkit.layout.RasterLayout
    }]);
    pkg.WinLayer = Class(pkg.HtmlLayer, ui.WinLayerMix, [function() {
        this.$super();
        this.element.style["z-index"] = 1e4
    }, function $clazz() {
        this.layout = new zebkit.layout.RasterLayout
    }]);
    pkg.PopupLayer = Class(pkg.HtmlLayer, ui.PopupLayerMix, [function $clazz() {
        this.layout = new ui.PopupLayerLayout([function doLayout(target) {
            if (target.kids.length > 0) {
                ...
                target.$container.style["pointer-events"] = "none"
            }
            this.$super(target)
        }])
    }]);
    ...
    ui.zCanvas = pkg.zCanvas = Class(pkg.HtmlCanvas, [function(element, w, h) {
        if (arguments.length === 0) {
            w = 400;
            h = 400;
            element = null
        ...
        zebkit.web.$focusin(this.$container, function(e) {}, true)
    }, function $clazz() {
        this.$canvases = [];
        ...
        this.$toElementX = function(pageX, pageY) {
            ...
            pageY -= this.offy;
            var c = this.$context.$states[this.$context.$curState];
            return (c.sx !== 1 || c.sy !== 1 || c.rotateVal !== 0 ? Math.round((c.crot * pageX + pageY * c.srot) / c.sx) : pageX) - c.dx
        };
        this.$toElementY = function(pageX, pageY) {
            pageX -= this.offx;
            pageY -= this.offy;
            var c = this.$context.$states[this.$context.$curState];
            return (c.sx !== 1 || c.sy !== 1 || c.rotateVal !== 0 ? Math.round((pageY * c.crot - c.srot * pageX) / c.sy) : pageY) - c.dy
        };
        this.load = function(jsonPath) {
        ...
        this.$pointerExited = function(e) {
            ...
            if (o !== null) {
                delete pkg.$pointerOwner[e.identifier];
                return ui.events.fire("pointerExited", e.update(o, this.$toElementX(e.pageX, e.pageY), this.$toElementY(e.pageX, e.pageY)))
            }
        };
        this.$pointerMoved = function(e) {
            var x = this.$toElementX(e.pageX, e.pageY),
        ...
        this.$pointerDragged = function(e) {
            if (pkg.$pointerOwner.hasOwnProperty(e.identifier)) {
                return ui.events.fire("pointerDragged", e.update(pkg.$pointerOwner[e.identifier], this.$toElementX(e.pageX, e.pageY), this.$toElementY(e.pageX, e.pageY)))
            }
            return false
        };
        this.$pointerDragEnded = function(e) {
            if (pkg.$pointerOwner.hasOwnProperty(e.identifier)) {
                return ui.events.fire("pointerDragEnded", e.update(pkg.$pointerOwner[e.identifier], this.$toElementX(e.pageX, e.pageY), this.$toElementY(e.pageX, e.pageY)))
            }
            return false
        };
        ...
        this.$pointerDoubleClicked = function(e) {
            var x = this.$toElementX(e.pageX, e.pageY),
                y = this.$toElementY(e.pageX, e.pageY),
                d = this.getComponentAt(x, y);
            return d !== null ? ui.events.fire("pointerDoubleClicked", e.update(d, x, y)) : false
        };
        this.$pointerReleased = function(e) {
            var x = this.$toElementX(e.pageX, e.pageY),
                y = this.$toElementY(e.pageX, e.pageY);
            ...
            if (e.pointerType === "mouse" && (e.pressPageX !== e.pageX || e.pressPageY !== e.pageY)) {
                var nd = this.getComponentAt(x, y),
                    po = this.getComponentAt(this.$toElementX(e.pressPageX, e.pressPageY), this.$toElementY(e.pressPageX, e.pressPageY));
                if (nd !== po) {
                    if (po !== null) {
                        delete pkg.$pointerOwner[e.identifier];
        ...
        this.recalcOffset = function() {
            ...
            this.offx = Math.round(ba.left + zebkit.web.$measure(this.$container, "border-left-width") + zebkit.web.$measure(this.$container, "padding-left") + window.pageXOffset);
            this.offy = Math.round(ba.top + zebkit.web.$measure(this.$container, "padding-top") + zebkit.web.$measure(this.$container, "border-top-width") + window.pageYOffset);
        ...
        this.$initListeners = function() {
            ...
            new zebkit.web.KeyEventUnifier(this.element, this);
    ...
    window.addEventListener("resize", function(e) {
        if ($wpw !== window.innerWidth || $wph !== window.innerHeight) {
            ...
            if ($wrt !== null) {
                ...
                $wrt = zebkit.util.tasksSet.run(function() {
    ...
    var ui = pkg.cd("..");
    pkg.VideoPan = Class(ui.Panel, [function(src) {
        var $this = this;
        ...
        this.SignLabel = Class(ui.Panel, [function $clazz() {
        ...
        this.paint = function(g) {
            if (this.video.paused === false && this.video.ended === false && this.$cancelTask === null) {
            ...
            g.drawImage(this.video, this.$videoBound.x, this.$videoBound.y, this.$videoBound.width, this.$videoBound.height);
            if (this.showSign) {
                var sign = null;
