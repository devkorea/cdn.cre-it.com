	...
	app_.widget('ui.cx_tree', {
        options : { // $('ui.xxx').widget({},{}) 아무리 많은 param 도 처음정의된 options 에 extend 된다
              degug: false
            , expand_char: '+'
            , collapse_char: '-'
        ...
        * @returns  {void}
		...
		expand: function(branch, method) {
            try {
                ...
                var a = branch.siblings('div').children('.' + this.cfg.expand_link_class);
        ...
        * @returns  {void}
		...
		collapse: function(branch, method) {
            try {
                ...
                var a = branch.siblings('div').children('.' + this.cfg.collapse_link_class);
        ...
        * @returns  {void}
		...
		_set_with_root_option: function() {
            try {
                if (this.options.debug) console.log('cx_tree._set_with_root_option');
                ...
                console.error(e);
                throw '■■■ error: cx_tree._set_with_root_option ■■■';
            }
		},  // cx_tree._set_with_root_option
        ...
        * @returns  {void}
            ...
            try {
                ...
                $('ul', self).each(function() {
                    ...
                    if(ul.children('li').length == 0) {
                        ...
                        if(a.length == 0) {
                            div.children('a.' + _self.cfg.common_link_class).remove();
                            var character;
		...
		_init: function() {
            try {
                ...
                this._set_with_root_option();
                if(this.options.collapse_after_init) {
